...
namespace Neo.IronLua
{
	...
	public partial class Lua : IDisposable
	{
		...
		public LuaChunk CompileChunk(string fileName, LuaCompileOptions options, params MyKeyValuePair<string, Type>[] args)
		{
		...
		/// <param name="args">Arguments for the code block.</param>
		/// <returns>Compiled chunk.</returns>
		public LuaChunk CompileChunk(TextReader tr, string name, LuaCompileOptions options, params MyKeyValuePair<string, Type>[] args)
		{
		...
		/// <param name="args">Arguments for the code block.</param>
		/// <returns>Compiled chunk.</returns>
		public LuaChunk CompileChunk(string code, string name, LuaCompileOptions options, params MyKeyValuePair<string, Type>[] args)
		{
			if (String.IsNullOrEmpty(name))
				throw new ArgumentNullException(nameof(name));
		...
		/// <param name="args">Arguments for the code block.</param>
		/// <returns>Compiled chunk.</returns>
		public LuaChunk CompileChunk(ILuaLexer code, LuaCompileOptions options, params MyKeyValuePair<string, Type>[] args)
		{
			if (code == null)
		...
		/// <returns></returns>
		public object CompileOrReturnPrint(ILuaLexer code, LuaCompileOptions options, params MyKeyValuePair<string, Type>[] args)
		{
		...
		internal LuaChunk CompileChunkCore(ILuaLexer lex, LuaCompileOptions options, IEnumerable<MyKeyValuePair<string, Type>> args)
		{
			if (options == null)
		...
		/// <returns></returns>
		public Delegate CreateLambda(string name, string code, Type delegateType, Type returnType, params MyKeyValuePair<string, Type>[] arguments)
		{
			...
			where T : class
		{
			...
			var arguments = new MyKeyValuePair<string, Type>[parameters.Length];
			for (int i = 0; i < parameters.Length; i++)
			{
				arguments[i] = new MyKeyValuePair<string, Type>();
			}
		...
		private static MyDictionary<string, WeakReference> registeredChunks = new MyDictionary<string, WeakReference>();
