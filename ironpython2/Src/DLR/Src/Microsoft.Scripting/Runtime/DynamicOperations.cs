...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public sealed partial class DynamicOperations {
        ...
        private MyDictionary<SiteKey, SiteKey> _sites = new MyDictionary<SiteKey, SiteKey>();
        ...
        private MyDictionary<int, Func<DynamicOperations, CallSiteBinder, object, object[], object>> _invokers = new MyDictionary<int, Func<DynamicOperations, CallSiteBinder, object, object[], object>>();
        ...
        public T ConvertTo<T>(object obj) {
            ...
            // Debug.WriteLine($"obj type:{obj.GetReleaseType()}");
            return site.Target(site, obj);
        }
