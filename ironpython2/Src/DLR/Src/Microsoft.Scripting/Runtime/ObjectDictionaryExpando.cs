...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public sealed class ObjectDictionaryExpando : IDynamicMetaObjectProvider {
        private readonly IMyDictionary<object, object> _data;

        public ObjectDictionaryExpando(IMyDictionary<object, object> dictionary) {
            _data = dictionary;
        }

        public IMyDictionary<object, object> Dictionary => _data;
