...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public sealed class StringDictionaryExpando : IDynamicMetaObjectProvider {
        private readonly IMyDictionary<string, object> _data;
        internal static readonly object _getFailed = new object();

        public StringDictionaryExpando(IMyDictionary<string, object> data) {
            _data = data;
        }

        public IMyDictionary<string, object> Dictionary => _data;
    ...
    internal sealed class DictionaryExpandoMetaObject : DynamicMetaObject {
        ...
        private BindingRestrictions GetRestrictions() {
            return BindingRestrictions.GetTypeRestriction(Expression, Value.GetReleaseType());
        }
