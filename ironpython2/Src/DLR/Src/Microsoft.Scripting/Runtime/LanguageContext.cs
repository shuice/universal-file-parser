...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public abstract class LanguageContext {
        ...
        /// </summary>
        public virtual Scope CreateScope(IMyDictionary<string, object> dictionary) {
            ...
            public override DynamicMetaObject FallbackGetMember(DynamicMetaObject self, DynamicMetaObject errorSuggestion) {
                return errorSuggestion ?? new DynamicMetaObject(
                    ...
                    self.Value == null ?
                        ...
                        BindingRestrictions.GetTypeRestriction(self.Expression, self.Value.GetReleaseType())
                );
            }
        }
        ...
        public virtual void GetExceptionMessage(Exception exception, out string message, out string errorTypeName) {
            ...
            errorTypeName = exception.GetReleaseType().Name;
        }
