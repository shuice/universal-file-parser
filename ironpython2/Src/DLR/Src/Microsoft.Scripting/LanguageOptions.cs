...
namespace AnyPrefix.Microsoft.Scripting {
    ...
    public class LanguageOptions {
        ...
        public LanguageOptions(IMyDictionary<string, object> options) {
        ...
        public static T GetOption<T>(IMyDictionary<string, object> options, string name, T defaultValue) {
        ...
        /// </summary>
        public static ReadOnlyCollection<string> GetStringCollectionOption(IMyDictionary<string, object> options, string name, params char[] separators) {
            if (options == null || !options.TryGetValue(name, out object value)) {
                return null;
            }
        ...
        public static ReadOnlyCollection<string> GetSearchPathsOption(IMyDictionary<string, object> options) {
