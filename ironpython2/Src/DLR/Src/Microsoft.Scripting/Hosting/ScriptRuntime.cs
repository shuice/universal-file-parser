...
namespace AnyPrefix.Microsoft.Scripting.Hosting {
    ...
    public sealed class ScriptRuntime : MarshalByRefObject {
        private readonly MyDictionary<LanguageContext, ScriptEngine> _engines;
        ...
        public ScriptRuntime(ScriptRuntimeSetup setup) {
            ...
            _engines = new MyDictionary<LanguageContext, ScriptEngine>();
        ...
        public ScriptScope CreateScope(IMyDictionary<string, object> dictionary) {
            return InvariantEngine.CreateScope(dictionary);
        }

        public ScriptScope CreateScope(string languageId, IMyDictionary<string, object> storage) {
            return GetEngine(languageId).CreateScope(storage);
        }
