...
namespace AnyPrefix.Microsoft.Scripting.Debugging {
    public sealed class DebugSourceFile {
        ...
        private readonly MyDictionary<DebugSourceSpan, FunctionInfo> _functionInfoMap;

        internal DebugSourceFile(string fileName, DebugMode debugMode) {
            Name = fileName;
            _debugMode = debugMode;
            _functionInfoMap = new MyDictionary<DebugSourceSpan, FunctionInfo>();
        }

        internal MyDictionary<DebugSourceSpan, FunctionInfo> FunctionInfoMap {
