...
namespace AnyPrefix.Microsoft.Scripting.Debugging {
    ...
    internal class DebugInfoRewriter : MSAst.DynamicExpressionVisitor {
        ...
        private readonly MyDictionary<ParameterExpression, MSAst.ParameterExpression> _replacedLocals;
        private readonly MyDictionary<ParameterExpression, VariableInfo> _localsToVarInfos;
        private readonly Stack<BlockExpression> _currentLocals;
        private readonly MyDictionary<int, DebugSourceSpan> _markerLocationMap;
        private readonly MyDictionary<int, IList<VariableInfo>> _variableScopeMap;
        private readonly MyDictionary<BlockExpression, IList<VariableInfo>> _variableScopeMapCache;
        private readonly MyDictionary<DebugSourceFile, ParameterExpression> _sourceFilesToVariablesMap;
        ...
        internal DebugInfoRewriter(
            ...
            MyDictionary<DebugSourceFile, ParameterExpression> sourceFilesToVariablesMap,
            LabelTarget generatorLabel,
            MyDictionary<ParameterExpression, ParameterExpression> replacedLocals,
            MyDictionary<ParameterExpression, VariableInfo> localsToVarInfos,
            ...
            if (_transformToGenerator) {
                ...
                _markerLocationMap = new MyDictionary<int, DebugSourceSpan>();
                _variableScopeMap = new MyDictionary<int, IList<VariableInfo>>();
                _currentLocals = new Stack<BlockExpression>();
                _variableScopeMapCache = new MyDictionary<BlockExpression, IList<VariableInfo>>();
            }
