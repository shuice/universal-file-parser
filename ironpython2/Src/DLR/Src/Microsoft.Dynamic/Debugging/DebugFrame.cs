...
namespace AnyPrefix.Microsoft.Scripting.Debugging {
    ...
    public sealed class DebugFrame {
        ...
        private MyDictionary<IList<VariableInfo>, ScopeData> _variables;
        ...
        internal DebugFrame(
            ...
            Thread = thread;
            _funcInfo = funcInfo;
            _variables = new  MyDictionary<IList<VariableInfo>, ScopeData>();
        }
        ...
        internal IMyDictionary<object, object> GetLocalsScope() {
            ScopeData scopeData = CurrentScopeData;
            IMyDictionary<object, object> scope = scopeData.Scope;
            if (scope == null) {
        ...
        private void CreateGenerator(FunctionInfo targetFuncInfo) {
            ...
            _generator = (IDebuggableGenerator)targetFuncInfo.GeneratorFactory.GetReleaseType().GetMethod("Invoke").Invoke(targetFuncInfo.GeneratorFactory, paramValues);
        ...
        private class ScopeData {
            ...
            public IMyDictionary<object, object> Scope;
        }
    }
}
