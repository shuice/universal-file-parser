...
namespace AnyPrefix.Microsoft.Scripting.Debugging {
    ...
    internal sealed class LambdaWalker : MSAst.ExpressionVisitor {
        ...
        private readonly MyDictionary<MSAst.ParameterExpression, object> _strongBoxedLocals;

        internal LambdaWalker() {
            _locals = new List<MSAst.ParameterExpression>();
            _strongBoxedLocals = new MyDictionary<MSAst.ParameterExpression, object>();
        }
        ...
        internal MyDictionary<MSAst.ParameterExpression, object> StrongBoxedLocals {
