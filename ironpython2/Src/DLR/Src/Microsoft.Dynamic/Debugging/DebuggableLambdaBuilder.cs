...
namespace AnyPrefix.Microsoft.Scripting.Debugging {
    ...
    internal class DebuggableLambdaBuilder {
        ...
        private MyDictionary<DebugSourceFile, MSAst.ParameterExpression> _sourceFilesMap; // Map of source file instances to their variable nodes
        ...
        private readonly MyDictionary<string, object> _verifiedLocalNames;                // Unique names for locals
        private readonly List<VariableInfo> _variableInfos;                             // List of variables that'll be available at runtime
        private readonly MyDictionary<MSAst.ParameterExpression, VariableInfo> _pendingToVariableInfosMap;               // Map of original locals to their VariableInfo
        private readonly MyDictionary<MSAst.ParameterExpression, MSAst.ParameterExpression> _pendingToVerifiedLocalsMap; // Map of original locals to post-transform locals
        ...
        internal DebuggableLambdaBuilder(DebugContext debugContext, DebugLambdaInfo lambdaInfo) {
            ...
            _verifiedLocalNames = new MyDictionary<string, object>();
            _pendingLocals = new List<MSAst.ParameterExpression>();
            _variableInfos = new List<VariableInfo>();
            _pendingToVariableInfosMap = new MyDictionary<MSAst.ParameterExpression, VariableInfo>();
            _pendingToVerifiedLocalsMap = new MyDictionary<MSAst.ParameterExpression, MSAst.ParameterExpression>();
        ...
        private MSAst.LambdaExpression TransformLambda(MSAst.LambdaExpression lambda) {
            ...
            MyDictionary<MSAst.ParameterExpression, object> parameters = new MyDictionary<MSAst.ParameterExpression, object>();
        ...
        private void LayOutVariables(MyDictionary<MSAst.ParameterExpression, object> strongBoxedLocals, MyDictionary<MSAst.ParameterExpression, object> parameters) {
        ...
        private void LayoutVariablesForGenerator(MyDictionary<MSAst.ParameterExpression, object> parameters) {
            IList<MSAst.ParameterExpression> hiddenVariables = _lambdaInfo.HiddenVariables;
            int strongBoxIndex = 0;
        ...
        private MSAst.Expression TransformToGeneratorBody(MSAst.Expression body) {
            ...
            _sourceFilesMap = new MyDictionary<DebugSourceFile, MSAst.ParameterExpression>();
