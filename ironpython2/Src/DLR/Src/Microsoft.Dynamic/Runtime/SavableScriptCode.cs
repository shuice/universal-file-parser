...
namespace AnyPrefix.Microsoft.Scripting {
    ...
    public abstract class SavableScriptCode : ScriptCode {
        ...
        /// <summary>
        /// This will take an assembly object which the user has loaded and return a new set of ScriptCode which have 
        /// been loaded into the provided ScriptDomainManager.  
        /// 
        /// If the language associated with the ScriptCode has not already been loaded the DLR will load the 
