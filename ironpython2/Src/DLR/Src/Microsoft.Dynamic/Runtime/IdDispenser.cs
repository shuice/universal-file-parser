...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    public static class IdDispenser {
        ...
        [MultiRuntimeAware]
        private static MyDictionary<object, object> _hashtable = new MyDictionary<object, object>(_comparer);
        ...
        private static void Cleanup() {
            ...
            if (emptyCount > liveCount / 4) {
                MyDictionary<object, object> newtable = new MyDictionary<object, object>(liveCount + liveCount / 4, _comparer);
