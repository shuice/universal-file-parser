...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public abstract class CustomStringDictionary : IDictionary, IMyDictionary<object, object> {

        private MyDictionary<object, object> _data;
        ...
        public void CopyTo(MyKeyValuePair<object, object>[] array, int arrayIndex) {
            ...
            foreach (MyKeyValuePair<object, object> kvp in ((IEnumerable<MyKeyValuePair<object, object>>)this)) {
        ...
        IEnumerator<MyKeyValuePair<object, object>> IEnumerable<MyKeyValuePair<object, object>>.GetEnumerator() {
            if (_data != null) {
                foreach (MyKeyValuePair<object, object> o in _data) {
                    yield return o;
                }
            }
            ...
            foreach (var o in GetExtraKeys()) {
                if (TryGetExtraValue(o, out object val) && val != Uninitialized.Instance) {
                    yield return new MyKeyValuePair<object, object>(o, val);
                }
            }
        }
        ...
        void IDictionary.Add(object key, object value) {
            ((IMyDictionary<object, object>)this).Add(key, value);
        }

        public bool Contains(object key) {
            object dummy;
            return ((IMyDictionary<object, object>)this).TryGetValue(key, out dummy);
        }
        ...
        ICollection IDictionary.Keys {
            get {
                return new List<object>(((IMyDictionary<object, object>)this).Keys);
            }
        }
        ...
        ICollection IDictionary.Values {
            get {
                return new List<object>(((IMyDictionary<object, object>)this).Values);
            }
        }
        ...
        public virtual bool ValueEquals(object other) {
            ...
            IMyDictionary<object, object> oth = other as IMyDictionary<object, object>;
            IMyDictionary<object, object> ths = this as IMyDictionary<object, object>;

            if (oth?.Count != ths.Count) return false;

            foreach (MyKeyValuePair<object, object> o in ths) {
