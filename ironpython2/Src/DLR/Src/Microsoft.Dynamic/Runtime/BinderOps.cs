...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public static class BinderOps {
        ...
        public static MyDictionary<TKey, TValue> MakeDictionary<TKey, TValue>(string[] names, object[] values) {
            Debug.Assert(typeof(TKey) == typeof(string) || typeof(TKey) == typeof(object));

            MyDictionary<TKey, TValue> res = new MyDictionary<TKey, TValue>(names.Length);
        ...
        public static IMyReadOnlyDictionary<TKey, TValue> MakeReadOnlyDictionary<TKey, TValue>(string[] names, object[] values) {
            if (names.Length == 0) {
