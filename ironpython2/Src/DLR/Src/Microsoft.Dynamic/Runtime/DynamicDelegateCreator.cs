...
namespace AnyPrefix.Microsoft.Scripting.Runtime {
    ...
    public class DynamicDelegateCreator {
        ...
        public Delegate GetDelegate(object callableObject, Type delegateType) {
            ...
            if (callableObject is Delegate result) {
                if (!delegateType.IsInstanceOfType(result)) {
                    throw ScriptingRuntimeHelpers.SimpleTypeError($"Cannot cast {result.GetReleaseType()} to {delegateType}.");
                }
        ...
        //
        private static System.Runtime.CompilerServices.ConditionalWeakTable<object, System.Collections.Generic.MyDictionary<Type, Delegate>> _dynamicDelegateCache =
            new System.Runtime.CompilerServices.ConditionalWeakTable<object, System.Collections.Generic.MyDictionary<Type, Delegate>>();
