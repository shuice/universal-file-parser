...
namespace AnyPrefix.Microsoft.Scripting.Actions {
    ...
    internal class OperatorInfo {
        private static MyDictionary<ExpressionType, OperatorInfo> _infos = MakeOperatorTable(); // table of ExpressionType, names, and alt names for looking up methods.
        ...
        private static MyDictionary<ExpressionType, OperatorInfo> MakeOperatorTable() {
            var res = new MyDictionary<ExpressionType, OperatorInfo>();
