...
namespace AnyPrefix.Microsoft.Scripting.Actions.Calls {
    public static class TypeInferer {
        private static ArgumentInputs EnsureInputs(MyDictionary<Type, ArgumentInputs> dict, Type type) {
        ...
        internal static MethodCandidate InferGenericMethod(ApplicableCandidate/*!*/ candidate, ActualArguments/*!*/ actualArgs) {
            ...
            MyDictionary<Type, List<Type>> dependencies = GetDependencyMapping(target);
            Type[] genArgs = GetSortedGenericArguments(target, dependencies);
            MyDictionary<Type, ArgumentInputs> inputs = GetArgumentToInputMapping(candidate.Method, args);

            // now process the inputs
            var binding = new MyDictionary<Type, Type>();
            var restrictions = new MyDictionary<DynamicMetaObject, BindingRestrictions>();
            bool noMethod = false;
        ...
        /// </summary>
        private static Type[] GetGenericArgumentsForInferedMethod(OverloadInfo target, MyDictionary<Type, Type> constraints) {
        ...
        /// their dependencies.
        /// </summary>
        private static Type[] GetSortedGenericArguments(OverloadInfo info, MyDictionary<Type, List<Type>> dependencies) {
        ...
        /// </summary>
        private static bool IsDependentConstraint(MyDictionary<Type, List<Type>> dependencies, Type x, Type y) {
        ...
        /// </summary>
        private static MyDictionary<Type, List<Type>> GetDependencyMapping(OverloadInfo info) {
            MyDictionary<Type, List<Type>> dependencies = new MyDictionary<Type, List<Type>>();
        ...
        private static void AddNestedDependencies(MyDictionary<Type, List<Type>> dependencies, Type genArg, Type t) {
        ...
        private static void AddDependency(MyDictionary<Type, List<Type>> dependencies, Type genArg, Type t) {
        ...
        /// </summary>
        private static MyDictionary<Type/*!*/, ArgumentInputs/*!*/>/*!*/ GetArgumentToInputMapping(MethodCandidate/*!*/ candidate, IList<DynamicMetaObject/*!*/>/*!*/ args) {
            MyDictionary<Type, ArgumentInputs> inputs = new MyDictionary<Type, ArgumentInputs>();
        ...
        /// </summary>
        private static void AddOneInput(MyDictionary<Type, ArgumentInputs> inputs, DynamicMetaObject arg, Type paramType) {
        ...
        private class ArgumentInputs {
            ...
            public Type GetBestType(OverloadResolver/*!*/ resolver, MyDictionary<Type, Type>/*!*/ binding, MyDictionary<DynamicMetaObject, BindingRestrictions>/*!*/ restrictions) {
                Type curType = null;
        ...
        internal static Type GetInferedType(OverloadResolver/*!*/ resolver, Type/*!*/ genericParameter, Type/*!*/ parameterType,
            DynamicMetaObject/*!*/ input, MyDictionary<Type, Type>/*!*/ binding, MyDictionary<DynamicMetaObject, BindingRestrictions>/*!*/ restrictions) {
        ...
        ///   M{T}(ref Dictionary{T,T}[] x)
        /// </remarks>
        public static Type GetInferedType(Type/*!*/ genericParameter, Type/*!*/ parameterType, Type inputType, Type/*!*/ argType, MyDictionary<Type, Type>/*!*/ binding) {
        ...
        //
        private static Type GetInferedTypeForInterface(Type/*!*/ genericParameter, Type/*!*/ interfaceType, Type inputType, MyDictionary<Type, Type>/*!*/ binding) {
        ...
        /// </summary>
        private static bool ConstraintsViolated(Type inputType, Type genericMethodParameterType, MyDictionary<Type, Type> binding) {
            return ReflectionUtils.ConstraintsViolated(genericMethodParameterType, inputType, binding, false);
        }

        private static Type MatchGenericParameter(Type genericParameter, Type closedType, Type openType, MyDictionary<Type, Type> binding) {
            Type match = null;
        ...
        /// </summary>
        private static bool MatchGenericParameter(Type genericParameter, Type closedType, Type openType, MyDictionary<Type, Type> binding, ref Type match) {
            Type m = match;
