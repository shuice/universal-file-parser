...
namespace AnyPrefix.Microsoft.Scripting.Actions.Calls {
    ...
    public sealed class MethodCandidate {
        ...
        internal MethodCandidate(OverloadResolver resolver, OverloadInfo method, List<ParameterWrapper> parameters, ParameterWrapper paramsDict,
            ReturnBuilder returnBuilder, InstanceBuilder instanceBuilder, IList<ArgBuilder> argBuilders, MyDictionary<DynamicMetaObject, BindingRestrictions> restrictions) {
        ...
        internal MethodCandidate ReplaceMethod(OverloadInfo newMethod, List<ParameterWrapper> parameters, IList<ArgBuilder> argBuilders, MyDictionary<DynamicMetaObject, BindingRestrictions> restrictions) {
        ...
        internal MyDictionary<DynamicMetaObject, BindingRestrictions> Restrictions { get; }
