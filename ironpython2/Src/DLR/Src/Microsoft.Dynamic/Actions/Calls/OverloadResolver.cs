...
namespace AnyPrefix.Microsoft.Scripting.Actions.Calls {
    ...
    public abstract partial class OverloadResolver {
        ...
        private MyDictionary<int, CandidateSet> _candidateSets;    // the methods as they map from # of arguments -> the possible CandidateSet's.
...
#pragma warning restore 618
        ...
        private void BuildCandidateSets(IEnumerable<OverloadInfo> methods) {
            ...
            _candidateSets = new MyDictionary<int, CandidateSet>();
