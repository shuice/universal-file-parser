...
namespace AnyPrefix.Microsoft.Scripting.Actions {
    ...
    public class MethodGroup : MemberTracker {
        ...
        private MyDictionary<TypeList, MethodGroup> _boundGenerics;
        ...
        private void EnsureBoundGenericDict() {
            if (_boundGenerics == null) {
                Interlocked.CompareExchange<MyDictionary<TypeList, MethodGroup>>(
                    ref _boundGenerics,
                    new MyDictionary<TypeList, MethodGroup>(1),
                    null);
            }
        }
