...
namespace AnyPrefix.Microsoft.Scripting.Actions {
    ...
    public sealed class TypeGroup : TypeTracker {
        private readonly MyDictionary<int, Type> _typesByArity;
        ...
        private TypeGroup(Type t1, int arity1, Type t2, int arity2) {
            ...
            _typesByArity = new MyDictionary<int, Type>();
        ...
        private TypeGroup(Type t1, TypeGroup existingTypes) {
            ...
            _typesByArity = new MyDictionary<int, Type>(existingTypes._typesByArity);
        ...
        public IMyDictionary<int, Type> TypesByArity => new MyReadOnlyDictionary<int, Type>(_typesByArity);
