...
namespace AnyPrefix.Microsoft.Scripting.Actions {
    ...
    /// </summary>
    public class NamespaceTracker : MemberTracker, IMembersList, IEnumerable<MyKeyValuePair<string, object>> {
        ...
        internal MyDictionary<string, MemberTracker> _dict = new MyDictionary<string, MemberTracker>();

        internal readonly List<Assembly> _packageAssemblies = new List<Assembly>();
        internal readonly MyDictionary<Assembly, TypeNames> _typeNames = new MyDictionary<Assembly, TypeNames>();
        ...
        public bool TryGetValue(string name, out MemberTracker value) {
            lock (_topPackage.HierarchyLock) {
                ...
                foreach (MyKeyValuePair<Assembly, TypeNames> kvp in _typeNames) {
        ...
        #region IEnumerable<MyKeyValuePair<string, object>> Members

        public IEnumerator<MyKeyValuePair<string, object>> GetEnumerator() {
            foreach (var key in Keys) {
                yield return new MyKeyValuePair<string, object>(key, this[key]);
            }
        }
        ...
        internal class TypeNames {
            ...
            MyDictionary<string, List<string>> _genericTypeNames = new MyDictionary<string, List<string>>();
        ...
        protected void UpdateSubtreeIds() {
            ...
            foreach (MyKeyValuePair<string, MemberTracker> kvp in _dict) {
