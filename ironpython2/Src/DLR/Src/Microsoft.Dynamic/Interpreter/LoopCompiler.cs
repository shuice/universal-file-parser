...
namespace AnyPrefix.Microsoft.Scripting.Interpreter {
    ...
    internal sealed class LoopCompiler : ExpressionVisitor {
        ...
        private readonly MyDictionary<ParameterExpression, LocalVariable> _outerVariables, _closureVariables; 
        ...
        private readonly MyDictionary<ParameterExpression, LoopVariable> _loopVariables;
        ...
        internal LoopCompiler(LoopExpression loop, HybridReferenceDictionary<LabelTarget, BranchLabel> labelMapping, MyDictionary<ParameterExpression, LocalVariable> locals,
            MyDictionary<ParameterExpression, LocalVariable> closureVariables, int loopStartInstructionIndex, int loopEndInstructionIndex) {
            _loop = loop;
            ...
            _loopVariables = new MyDictionary<ParameterExpression, LoopVariable>();
