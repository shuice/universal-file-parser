...
namespace AnyPrefix.Microsoft.Scripting.Interpreter {
    ...
    public sealed class LocalVariables {
        ...
        /// </summary>
        /// <returns></returns>
        internal MyDictionary<ParameterExpression, LocalVariable> CopyLocals() {
            var res = new MyDictionary<ParameterExpression, LocalVariable>(_variables.Count);
        ...
        /// </summary>
        internal MyDictionary<ParameterExpression, LocalVariable> ClosureVariables { get; private set; }

        internal LocalVariable AddClosureVariable(ParameterExpression variable) {
            if (ClosureVariables == null) {
                ClosureVariables = new MyDictionary<ParameterExpression, LocalVariable>();
            }
