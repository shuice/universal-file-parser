...
namespace AnyPrefix.Microsoft.Scripting.Hosting.Shell {
    /// <summary>
    ...
    public abstract class ConsoleHost {
        ...
        private static void InsertSearchPaths(IMyDictionary<string, object> options, ICollection<string> paths) {
