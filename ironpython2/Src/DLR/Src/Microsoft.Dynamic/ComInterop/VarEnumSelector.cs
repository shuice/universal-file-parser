...
using AnyPrefix.Microsoft.Scripting.ComInterop;
...
namespace AnyPrefix.Microsoft.Scripting.ComInterop {
    ...
    internal class VarEnumSelector {
        ...
        private static readonly MyDictionary<VarEnum, Type> _ComToManagedPrimitiveTypes = CreateComToManagedPrimitiveTypes();
        ...
        private static MyDictionary<VarEnum, Type> CreateComToManagedPrimitiveTypes() {
            MyDictionary<VarEnum, Type> dict = new MyDictionary<VarEnum, Type>();
