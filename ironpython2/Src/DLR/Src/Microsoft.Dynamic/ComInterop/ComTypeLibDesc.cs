...
namespace AnyPrefix.Microsoft.Scripting.ComInterop {
    ...
    public sealed class ComTypeLibDesc : IDynamicMetaObjectProvider {
        ...
        MyDictionary<string, ComTypeEnumDesc> _enums;
        string _typeLibName;
        ComTypes.TYPELIBATTR _typeLibAttributes;

        private static MyDictionary<Guid, ComTypeLibDesc> _CachedTypeLibDesc = new MyDictionary<Guid, ComTypeLibDesc>();

        private ComTypeLibDesc() {
            _enums = new MyDictionary<string, ComTypeEnumDesc>();
        ...
        public string[] GetMemberNames() {
            ...
            foreach (MyKeyValuePair<string, ComTypeEnumDesc> enumDesc in _enums) {
