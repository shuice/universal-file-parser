...
namespace AnyPrefix.Microsoft.Scripting.ComInterop {
    ...
    public class ComTypeDesc : ComTypeLibMemberDesc {
        ...
        private MyDictionary<string, ComEventDesc> _events;
        private static readonly MyDictionary<string, ComEventDesc> _EmptyEventsDict = new MyDictionary<string, ComEventDesc>();
        ...
        internal static MyDictionary<string, ComEventDesc> EmptyEvents {
        ...
        internal MyDictionary<string, ComEventDesc> Events {
            get { return _events; }
            set { _events = value; }
        }
        ...
        internal string[] GetMemberNames(bool dataOnly) {
            var names = new MyDictionary<string, object>();
