...
namespace AnyPrefix.Microsoft.Scripting.Utils {
    ...
    public static class CollectionUtils {
        ...
        public static IDictionaryEnumerator ToDictionaryEnumerator(IEnumerator<MyKeyValuePair<object, object>> enumerator) {
            return new DictionaryEnumerator(enumerator);
        }

        private sealed class DictionaryEnumerator : IDictionaryEnumerator {
            private readonly IEnumerator<MyKeyValuePair<object, object>> _enumerator;

            public DictionaryEnumerator(IEnumerator<MyKeyValuePair<object, object>> enumerator) {
