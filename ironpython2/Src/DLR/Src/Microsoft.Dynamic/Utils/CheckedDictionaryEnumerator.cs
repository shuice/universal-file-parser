...
namespace AnyPrefix.Microsoft.Scripting.Utils {
    ...
    /// </summary>
    public abstract class CheckedDictionaryEnumerator : IDictionaryEnumerator, IEnumerator<MyKeyValuePair<object, object>> {
        ...
        #region IEnumerator<MyKeyValuePair<object,object>> Members

        MyKeyValuePair<object, object> IEnumerator<MyKeyValuePair<object, object>>.Current {
            get { return new MyKeyValuePair<object, object>(Key, Value); }
        }
