...
using AnyPrefix.Microsoft.Scripting.Metadata;
#endif
...
namespace AnyPrefix.Microsoft.Scripting.Utils {
    public static class ReflectionUtils {
        ...
        public static object UnwrapEnumValue(object value) {
            ...
            switch (value.GetReleaseType().GetTypeCode()) {
                case TypeCode.Byte:
        ...
        private static MyDictionary<Assembly, MyDictionary<string, List<ExtensionMethodInfo>>> _extensionMethodsCache;
        ...
        /// </summary>
        public static IEnumerable<MyKeyValuePair<string, IEnumerable<ExtensionMethodInfo>>> GetVisibleExtensionMethodGroups(Assembly/*!*/ assembly, bool useCache) {
#if FEATURE_REFEMIT
            useCache &= !assembly.IsDynamic;
#endif
            if (useCache) {
                if (_extensionMethodsCache == null) {
                    _extensionMethodsCache = new MyDictionary<Assembly, MyDictionary<string, List<ExtensionMethodInfo>>>();
                }

                lock (_extensionMethodsCache) {
                    if (_extensionMethodsCache.TryGetValue(assembly, out MyDictionary<string, List<ExtensionMethodInfo>> existing)) {
                        return EnumerateExtensionMethods(existing);
                    }
                }
            }

            MyDictionary<string, List<ExtensionMethodInfo>> result = null;
            foreach (MethodInfo method in GetVisibleExtensionMethodsSlow(assembly)) {
                ...
                if (result == null) {
                    result = new MyDictionary<string, List<ExtensionMethodInfo>>();
                }
        ...
        private static IEnumerable<MyKeyValuePair<string, IEnumerable<ExtensionMethodInfo>>> EnumerateExtensionMethods(MyDictionary<string, List<ExtensionMethodInfo>> dict) {
            if (dict != null) {
                foreach (var entry in dict) {
                    yield return new MyKeyValuePair<string, IEnumerable<ExtensionMethodInfo>>(entry.Key, new ReadOnlyCollection<ExtensionMethodInfo>(entry.Value));
                }
            }
        }
        ...
        internal static MyDictionary<Type, Type> BindGenericParameters(Type/*!*/ openType, Type/*!*/ closedType, bool ignoreUnboundParameters) {
        ...
        internal static bool ConstraintsViolated(MyDictionary<Type, Type>/*!*/ binding, bool ignoreUnboundParameters) {
        ...
        internal static bool ConstraintsViolated(Type/*!*/ genericParameter, Type/*!*/ closedType, MyDictionary<Type, Type>/*!*/ binding, bool ignoreUnboundParameters) {
        ...
        internal static Type InstantiateConstraint(Type/*!*/ constraint, MyDictionary<Type, Type>/*!*/ binding) {
