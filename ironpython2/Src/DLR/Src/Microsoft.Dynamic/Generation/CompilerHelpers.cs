...
namespace AnyPrefix.Microsoft.Scripting.Generation {
    ...
    public static class CompilerHelpers {
        ...
        private sealed class DebuggableCodeRewriter : DynamicExpressionVisitor {
            private readonly MyDictionary<object, FieldBuilder> _fields = new MyDictionary<object, FieldBuilder>(ReferenceEqualityComparer<object>.Instance);
            ...
            protected override Expression VisitConstant(ConstantExpression node) {
                ...
                if (!_fields.TryGetValue(node.Value, out FieldBuilder field)) {
                    field = _type.DefineField(
                        ...
                        GetVisibleType(node.Value.GetReleaseType()),
