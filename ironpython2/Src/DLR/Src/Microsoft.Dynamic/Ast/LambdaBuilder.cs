...
namespace AnyPrefix.Microsoft.Scripting.Ast {
    ...
    public class LambdaBuilder {
        ...
        private readonly List<MyKeyValuePair<ParameterExpression, bool>> _visibleVars = new List<MyKeyValuePair<ParameterExpression, bool>>();
        ...
        public ParameterExpression Parameter(Type type, string name) {
            ...
            _params.Add(result);
            _visibleVars.Add(new MyKeyValuePair<ParameterExpression, bool>(result, false));
            return result;
        }
        ...
        public ParameterExpression ClosedOverParameter(Type type, string name) {
            ...
            ParameterExpression result = Expression.Parameter(type, name);
            _params.Add(result);
            _visibleVars.Add(new MyKeyValuePair<ParameterExpression, bool>(result, true));
            return result;
        }
        ...
        private void EnsureSignature(Type delegateType) {
            ...
            MyDictionary<ParameterExpression, ParameterExpression> paramMapping = new MyDictionary<ParameterExpression, ParameterExpression>();
            ...
            for (int i = 0; i < _visibleVars.Count; i++) {
                ...
                if (p != null && paramMapping.TryGetValue(p, out ParameterExpression v)) {
                    _visibleVars[i] = new MyKeyValuePair<ParameterExpression, bool>(v, _visibleVars[i].Value);
                }
            }
        }
