...
namespace IronPython.Modules {
    public static class PythonIterTools {
        ...
        public class izip_longest : IEnumerator {
            ...
            public izip_longest([ParamDictionary]IMyDictionary<object, object> paramDict, params object[] iterables) {
                object fill;
        ...
        private static Exception UnexpectedKeywordArgument(IMyDictionary<object, object> paramDict) {
        ...
        public class product : IterBase {
            ...
            public product([ParamDictionary]IMyDictionary<object, object> paramDict, params object[] iterables) {
                object repeat;
                int iRepeat = 1;
