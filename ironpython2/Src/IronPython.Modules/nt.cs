...
#if FEATURE_PROCESS
        private static MyDictionary<int, Process> _processToIdMapping = new MyDictionary<int, Process>();
...
are defined in the signal module.")]
        ...
        private static Exception ToPythonException(Exception e, string filename) {
            ...
            Runtime.Exceptions.Win32Exception winExcep = e as Runtime.Exceptions.Win32Exception;
            if (winExcep != null) {
