...
namespace IronPython.Modules {
    public class PythonCollections {
        ...
        public class deque : IEnumerable, IComparable, ICodeFormattable, IStructuralEquatable, IStructuralComparable, ICollection, IReversible
        {
            ...
            public deque([ParamDictionary]IMyDictionary<object, object> dict, params object[] args)
                : this() {
            }
            ...
            public void __init__([ParamDictionary]IMyDictionary<object, object> dict) {
            ...
            public void __init__(object iterable, [ParamDictionary]IMyDictionary<object, object> dict) {
            ...
            private static int VerifyMaxLen(IMyDictionary<object, object> dict) {
                if (dict.Count != 1) {
        ...
        public class defaultdict : PythonDictionary {
            ...
            public void __init__(CodeContext/*!*/ context, object default_factory, [ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {
