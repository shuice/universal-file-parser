...
namespace IronPython.Modules {
    ...
    public static class PythonCopyReg {
        ...
        public static void remove_extension(CodeContext/*!*/ context, object moduleName, object objectName, object value) {
            ...
            if (((IMyDictionary<object, object>)GetExtensionRegistry(context)).TryGetValue(key, out existingCode) &&
                ((IMyDictionary<object, object>)GetInvertedRegistry(context)).TryGetValue(code, out existingKey) &&
