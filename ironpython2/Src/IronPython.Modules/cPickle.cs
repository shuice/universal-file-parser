...
namespace IronPython.Modules {
    public static class PythonPickle {
        ...
        public class PicklerObject {
            ...
            private static readonly MyDictionary<Type, PickleFunction> _dispatchTable;

            private int _batchSize = 1000;
            private FileOutput _file;
            private int _protocol;
            private PythonDictionary _memo;               // memo if the user accesses the memo property
            private MyDictionary<object, int> _privMemo;    // internal fast memo which we can use if the user doesn't access memo
            private object _persist_id;

            static PicklerObject() {
                _dispatchTable = new MyDictionary<Type, PickleFunction>();
            ...
            public PicklerObject(CodeContext/*!*/ context, object file, object protocol, object bin) {
                ...
                _privMemo = new MyDictionary<object, int>(256, ReferenceEqualityComparer.Instance);
                ...
                if (_persist_id == null || !TrySavePersistId(context, obj)) {
                    ...
                    if (obj == null) {
                        ...
                        if (obj is string) {
                            ...
                            if (!_dispatchTable.TryGetValue(obj.GetReleaseType(), out pickleFunction)) {
            ...
            private void SaveObject(PicklerObject/*!*/ pickler, CodeContext/*!*/ context, object obj) {
                ...
                if (((IMyDictionary<object, object>)PythonCopyReg.GetDispatchTable(context)).TryGetValue(objType, out reduceCallable)) {
            ...
            private void BatchSetItems(CodeContext/*!*/ context, PythonDictionary dict) {
                MyKeyValuePair<object, object> kvTuple;
            ...
            private object FindModuleForGlobal(CodeContext/*!*/ context, object obj, object name) {
                ...
                if (pt != null) {
                    ...
                    foreach (MyKeyValuePair<object, object> modulePair in context.LanguageContext.SystemStateModules) {
        ...
        public class UnpicklerObject {
            ...
            private void LoadReduce(CodeContext/*!*/ context) {
                ...
                } else if (args.GetReleaseType() != typeof(PythonTuple)) {
