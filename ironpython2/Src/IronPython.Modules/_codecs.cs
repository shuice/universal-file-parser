...
namespace IronPython.Modules {
    public static class PythonCodecs {
        ...
        public static PythonTuple charmap_encode(CodeContext context, [BytesConversion]string input, string errors = "strict", IMyDictionary<object, object> map = null) {
        ...
        public static PythonTuple charmap_decode(CodeContext context, [BytesConversion]string input, string errors = "strict", IMyDictionary<object, object> map = null) {
            Encoding e = map != null ? new CharmapEncoding(map, errors) : null;
    ...
    public class EncodingMap {
        internal MyDictionary<int, char> Mapping = new MyDictionary<int, char>();
    }
    ...
    class CharmapEncoding : Encoding {
        private readonly IMyDictionary<object, object> _map;
        private readonly string _errors;

        public CharmapEncoding(IMyDictionary<object, object> map, string errors) {
            _map = map;
            _errors = errors;
            FixupMap();
        }
