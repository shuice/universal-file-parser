...
namespace IronPython.Modules {
    public static class FunctionTools {
        ...
        public class partial : IWeakReferenceable {
            ...
            private IMyDictionary<object, object> _keywordArgs;                               // the initially provided keyword arguments or null
            private CodeContext/*!*/ _context;                                              // code context from the caller who created us
            private CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>> _dictSite; // the dictionary call site if ever called w/ keyword args
            ...
            /// </summary>
            public partial(CodeContext/*!*/ context, object func, [ParamDictionary]IMyDictionary<object, object> keywords, [NotNull]params object[]/*!*/ args) {
            ...
            /// </summary>
            [SpecialName]
            public object Call(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {

                IMyDictionary<object, object> finalDict;
                if (_keywordArgs != null) {
            ...
            private void EnsureDictSplatSite() {
                if (_dictSite == null) {
                    Interlocked.CompareExchange(
                        ref _dictSite,
                        CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>.Create(
