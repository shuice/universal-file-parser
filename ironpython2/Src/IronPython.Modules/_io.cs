...
namespace IronPython.Modules {
    public static partial class PythonIOModule {
        ...
        public class _IOBase : IDisposable, IEnumerator<object>, IEnumerable<object>, IWeakReferenceable, IDynamicMetaObjectProvider, IPythonExpandable {
            ...
            private IMyDictionary<string, object> _customAttributes;

            IMyDictionary<string, object> IPythonExpandable.EnsureCustomAttributes() {
                return _customAttributes = new MyDictionary<string, object>();
            }

            IMyDictionary<string, object> IPythonExpandable.CustomAttributes {
