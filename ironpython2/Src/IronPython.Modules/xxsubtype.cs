...
namespace IronPython.Modules {    
    ...
    public static class xxsubtype {
        ...
        public class spamlist : List {
            ...
            public static object staticmeth([ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {
                return PythonTuple.MakeTuple(null, PythonTuple.MakeTuple(args), dict);
            }

            [ClassMethod]
            public static object classmeth(PythonType cls, [ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {
