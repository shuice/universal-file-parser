    ...
    public abstract class HashBase<T>
        ...
        protected T CloneHasher() {
            ...
            if (_memberwiseClone == null) {
                _memberwiseClone = _hasher.GetReleaseType().GetMethod("MemberwiseClone", BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
            }
            ...
            FieldInfo[] fields = _hasher.GetReleaseType().GetFields(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public);
            if(fields != null) {
