...
namespace IronPython.Modules {
    public static class PythonOperator {
        ...
        public class methodcaller {
            ...
            private readonly IMyDictionary<object, object> _dict;
            ...
            public methodcaller(string name, [ParamDictionary]IMyDictionary<object, object> kwargs, params object[] args) {
                _name = name;
                _args = args;
                _dict = kwargs;
            }
