...
namespace IronPython.Modules {
    public static class PythonSelect {
        ...
        public static PythonTuple select(CodeContext/*!*/ context, object iwtd, object owtd, object ewtd, [DefaultParameterValue(null)] object timeout) {
            ...
            MyDictionary<Socket, object> readerOriginals, writerOriginals, errorOriginals;
        ...
        /// </summary>
        private static void ProcessSocketSequence(CodeContext context, object sequence, out List socketList, out MyDictionary<Socket, object> socketToOriginal) {
            socketToOriginal = new MyDictionary<Socket, object>();
            socketList = new List();
