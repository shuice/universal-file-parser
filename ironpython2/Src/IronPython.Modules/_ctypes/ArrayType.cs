...
namespace IronPython.Modules {
    ...
    public static partial class CTypes {
        private static WeakDictionary<PythonType, MyDictionary<int, ArrayType>> _arrayTypes = new WeakDictionary<PythonType, MyDictionary<int, ArrayType>>();
...
#region INativeType Members
        ...
        private static ArrayType/*!*/ MakeArrayType(PythonType type, int count) {
            ...
            lock (_arrayTypes) {
                if (!_arrayTypes.TryGetValue(type, out MyDictionary<int, ArrayType> countDict)) {
                    _arrayTypes[type] = countDict = new MyDictionary<int, ArrayType>();
                }
