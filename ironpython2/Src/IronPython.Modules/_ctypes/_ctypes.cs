...
namespace IronPython.Modules {
    ...
    public static partial class CTypes {
        ...
        private static MyDictionary<object, RefCountInfo> _refCountTable;                   // dictionary used to maintain a ref count on objects
        private static ModuleBuilder _dynamicModule;                                      // the dynamic module we generate unsafe code into
        private static MyDictionary<int, Type> _nativeTypes = new MyDictionary<int, Type>();  // native types of the specified size for marshalling
        ...
        private static void EnsureRefCountTable() {
            if (_refCountTable == null) {
                Interlocked.CompareExchange(ref _refCountTable, new MyDictionary<object, RefCountInfo>(), null);
            }
        }
