...
namespace IronPython.Modules {
    ...
    public static partial class CTypes {
        ...
        public class CFuncPtrType : PythonType, INativeType {
            ...
            private static MyDictionary<DelegateCacheKey, Type> _reverseDelegates = new MyDictionary<DelegateCacheKey, Type>();
            ...
            private void MakeReverseDelegateWorker(CodeContext context) {
                ...
                LocalBuilder siteLocal = ilGen.DeclareLocal(site.GetReleaseType());
                ilGen.Emit(OpCodes.Ldarg_0);
                ilGen.Emit(OpCodes.Ldc_I4, constantPool.Count - 1);
                ilGen.Emit(OpCodes.Ldelem_Ref);
                ilGen.Emit(OpCodes.Castclass, site.GetReleaseType());
                ilGen.Emit(OpCodes.Stloc, siteLocal);
                ilGen.Emit(OpCodes.Ldloc, siteLocal);
                ilGen.Emit(OpCodes.Ldfld, site.GetReleaseType().GetField("Target"));
                ilGen.Emit(OpCodes.Ldloc, siteLocal);
