...
{
    using DialectRegistry = MyDictionary<string, PythonCsvModule.Dialect>;
...
dialect = csv.register_dialect(name, dialect)")]
        public static void register_dialect(CodeContext/*!*/ context,
            [ParamDictionary] IMyDictionary<object, object> kwArgs,
            params object[] args)
        {
            string name = null;
...
The Dialect type records CSV parsing and generation options.")]
        ...
        public class Dialect
        {
                ...
                params object[] args)
            {
                ...
                MyDictionary<string, bool> foundParams =
                    new MyDictionary<string, bool>();
                    ...
                    do
                    {
                        ...
                        if (!(lineobj is string))
                        {
                            throw PythonOps.TypeError("expected string or " +
                                ...
                                DynamicHelpers.GetPythonType(lineobj.GetReleaseType()));
                        }
