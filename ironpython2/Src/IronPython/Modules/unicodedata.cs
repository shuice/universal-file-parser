...
namespace IronPython.Modules {
    public static class unicodedata {
        ...
        public class UCD {
            ...
            private MyDictionary<int, CharInfo> database;
            private List<RangeInfo> ranges;
            private MyDictionary<string, int> nameLookup;
            ...
            void BuildDatabase(StreamReader data) {
                ...
                database = new MyDictionary<int, CharInfo>();
            ...
            void BuildNameLookup() {
                nameLookup = new MyDictionary<string, int>();
                foreach(var item in database.Where(c => !c.Value.Name.StartsWith("<")))
                {
                    nameLookup[item.Value.Name] = item.Key;
                }
            }
