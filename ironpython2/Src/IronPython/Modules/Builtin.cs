...
namespace IronPython.Modules {
    ...
    public static partial class Builtin {
        ...
        public class _basestring {
            public static void __new__(CodeContext/*!*/ context, object cls, [ParamDictionary]IMyDictionary<object, object> kwargs, params object[] args) {
        ...
        public static object compile(CodeContext/*!*/ context, object source, string filename, string mode, [DefaultParameterValue(null)]object flags, [DefaultParameterValue(null)]object dont_inherit) {
            ...
            if (source is string)
                ...
                throw PythonOps.TypeError("source can be either AST or string, actual argument: {0}", source.GetReleaseType());
        ...
        public static object max(CodeContext/*!*/ context, object x, [ParamDictionary]IMyDictionary<object, object> dict) {
            IEnumerator i = PythonOps.GetEnumerator(x);
            if (!i.MoveNext())
                throw PythonOps.ValueError(" max() arg is an empty sequence");
        ...
        public static object max(CodeContext/*!*/ context, object x, object y, [ParamDictionary] IMyDictionary<object, object> dict) {
            object method = GetMaxKwArg(dict);
            PythonContext pc = context.LanguageContext;
            return pc.GreaterThan(PythonCalls.Call(context, method, x), PythonCalls.Call(context, method, y)) ? x : y;
        }

        public static object max(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {
            if (args.Length > 0) {
                int retIndex = 0;
                if (args.Length == 1) {
        ...
        private static object GetMaxKwArg(IMyDictionary<object, object> dict) {
            if (dict.Count != 1)
        ...
        public static object min(CodeContext/*!*/ context, object x, [ParamDictionary]IMyDictionary<object, object> dict) {
            IEnumerator i = PythonOps.GetEnumerator(x);
            if (!i.MoveNext())
        ...
        public static object min(CodeContext/*!*/ context, object x, object y, [ParamDictionary]IMyDictionary<object, object> dict) {
            object method = GetMinKwArg(dict);
            return context.LanguageContext.LessThan(PythonCalls.Call(context, method, x), PythonCalls.Call(context, method, y)) ? x : y;
        }

        public static object min(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> dict, params object[] args) {
            if (args.Length > 0) {
                int retIndex = 0;
                if (args.Length == 1) {
        ...
        private static object GetMinKwArg([ParamDictionary]IMyDictionary<object, object> dict) {
            if (dict.Count != 1)
        ...
        private static object VerifyKeys(string name, IMyDictionary<object, object> dict) {
            object value;
        ...
        public static void print(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> kwargs, params object[] args) {
        ...
        private static object AttrCollectionPop(IMyDictionary<object, object> kwargs, string name, object defaultValue) {
            object res;
        ...
        private static void SumOne(ref SumState state, object current) {
            if (current != null) {
                if (state.CurType == SumVariantType.Int) {
                    if (current.GetReleaseType() == typeof(int)) {
                        try {
                    ...
                    } else if (current.GetReleaseType() == typeof(double)) {
                        state.DoubleVal = state.IntVal + ((double)current);
                        state.CurType = SumVariantType.Double;
                    } else if (current.GetReleaseType() == typeof(BigInteger)) {
                    ...
                    if (current.GetReleaseType() == typeof(double)) {
                        state.DoubleVal = state.DoubleVal + ((double)current);
                    } else if (current.GetReleaseType() == typeof(int)) {
                    ...
                    if (current.GetReleaseType() == typeof(BigInteger)) {
        ...
        struct SumState {
            ...
            public SumState(PythonContext context, object start) {
                ...
                if (start != null) {
                    if (start.GetReleaseType() == typeof(int)) {
                        CurType = SumVariantType.Int;
                        IntVal = (int)start;
                    } else if (start.GetReleaseType() == typeof(double)) {
                        CurType = SumVariantType.Double;
                        DoubleVal = (double)start;
                    } else if (start.GetReleaseType() == typeof(BigInteger)) {
