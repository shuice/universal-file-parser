...
namespace IronPython.Compiler {
    ...
    internal sealed class GeneratorRewriter : DynamicExpressionVisitor {
        ...
        private readonly MyDictionary<ParameterExpression, DelayedTupleExpression> _vars = new MyDictionary<ParameterExpression, DelayedTupleExpression>();
        private readonly List<MyKeyValuePair<ParameterExpression, DelayedTupleExpression>> _orderedVars = new List<MyKeyValuePair<ParameterExpression, DelayedTupleExpression>>();
        ...
        private DelayedTupleExpression LiftVariable(ParameterExpression param) {
            ...
            if (!_vars.TryGetValue(param, out res)) {
                ...
                _orderedVars.Add(new MyKeyValuePair<ParameterExpression, DelayedTupleExpression>(param, res));
            }
