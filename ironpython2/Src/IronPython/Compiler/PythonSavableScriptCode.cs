...
namespace IronPython.Compiler {
    ...
    class PythonSavableScriptCode : SavableScriptCode, ICustomScriptCodeData {
        ...
        protected override MyKeyValuePair<MethodBuilder, Type> CompileForSave(TypeGen typeGen) {
            ...
            return new MyKeyValuePair<MethodBuilder, Type>(mb, typeof(LookupCompilationDelegate));
        }
#endif
