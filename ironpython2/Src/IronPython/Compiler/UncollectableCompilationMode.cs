...
namespace IronPython.Compiler.Ast {
    ...
    partial class UncollectableCompilationMode : CompilationMode {
        private static readonly MyDictionary<object/*!*/, ConstantInfo/*!*/>/*!*/ _allConstants = new MyDictionary<object/*!*/, ConstantInfo/*!*/>();
        private static readonly MyDictionary<Type/*!*/, DelegateCache/*!*/>/*!*/ _delegateCache = new MyDictionary<Type/*!*/, DelegateCache/*!*/>();
        ...
        public override Type GetConstantType(object value) {
            if (value == null || value.GetReleaseType().IsValueType) {
                return typeof(object);
            }

            return value.GetReleaseType();
        }
        ...
        private sealed class DelegateCache {
            ...
            public MyDictionary<Type/*!*/, DelegateCache> TypeChain;
            ...
            public DelegateCache NextCacheNode(Type/*!*/ argType) {
                ...
                DelegateCache nextCacheNode;
                if (TypeChain == null) {
                    TypeChain = new MyDictionary<Type, DelegateCache>();
                }
        ...
        internal sealed class ConstantExpression : ReducibleExpression {
            ...
            public override Type/*!*/ Type {
                get {
                    Type returnType = _value.GetReleaseType();
            ...
            public override MSAst.Expression Reduce() {
                if (_value.GetReleaseType().IsValueType) {
                    return base.Reduce();
                } else {
                    return MSAst.Expression.Convert(base.Reduce(), _value.GetReleaseType());
                }
            }
        }
