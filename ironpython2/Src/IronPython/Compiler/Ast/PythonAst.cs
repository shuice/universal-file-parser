...
namespace IronPython.Compiler.Ast {
    ...
    public sealed class PythonAst : ScopeStatement {
        ...
        private MyDictionary<PythonVariable, MSAst.Expression> _globalVariables = new MyDictionary<PythonVariable, MSAst.Expression>();
        ...
        internal override void FinishBind(PythonNameBinder binder) {
            ...
            MyDictionary<string, PythonGlobal> globals = new MyDictionary<string, PythonGlobal>();
        ...
        internal MyDictionary<PythonVariable, MSAst.Expression> ModuleVariables {
            get {
        ...
        internal override AnyPrefix.Microsoft.Scripting.Ast.LightLambdaExpression GetLambda() {
        ...
        internal PythonAst MakeLookupCode() {
            ...
            MyDictionary<PythonVariable, MSAst.Expression> newGlobals = new MyDictionary<PythonVariable, MSAst.Expression>();
