...
namespace IronPython.Compiler.Ast {
    ...
    public class ForStatement : Statement, ILoopStatement {
        ...
        public override MSAst.Expression Reduce() {
            ...
            MSAst.ParameterExpression enumerator = Ast.Variable(typeof(MyKeyValuePair<IEnumerator, IDisposable>), "foreach_enumerator");
        ...
        internal static MSAst.Expression TransformFor(ScopeStatement parent, MSAst.ParameterExpression enumerator,
            ...
            MSAst.Expression init = Ast.Assign(
                    enumerator,
                    new PythonDynamicExpression1<MyKeyValuePair<IEnumerator, IDisposable>>(
            ...
            MSAst.Expression ls = AstUtils.Loop(
                    parent.GlobalParent.AddDebugInfo(
                        Ast.Call(
                            Ast.Property(
                                enumerator,
                                typeof(MyKeyValuePair<IEnumerator, IDisposable>).GetProperty("Key")
                            ),
            ...
            return Ast.Block(
                ...
                Ast.TryFinally(
                    ...
                    Ast.Block(
                        ...
                        Ast.Assign(enumerator, Ast.New(typeof(MyKeyValuePair<IEnumerator, IDisposable>)))
                    )
                )
            );
        }
