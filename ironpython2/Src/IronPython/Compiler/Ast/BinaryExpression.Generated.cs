        ...
        internal override ConstantExpression ConstantFold() {
            ...
            try {
                if (constLeft != null && constRight != null &&
                    ...
                    constLeft.Value.GetReleaseType() == constRight.Value.GetReleaseType()) {
                    #region Generated Python Constant Folding

                    // *** BEGIN GENERATED CODE ***
                    // generated by function: gen_constant_folding from: generate_ops.py

                    if (constLeft.Value.GetReleaseType() == typeof(Int32)) {
                        switch (_op) {
                    ...
                    if (constLeft.Value.GetReleaseType() == typeof(Double)) {
                        switch (_op) {
                    ...
                    if (constLeft.Value.GetReleaseType() == typeof(BigInteger)) {
                        switch (_op) {
                    ...
                    if (constLeft.Value.GetReleaseType() == typeof(Complex)) {
                        switch (_op) {
                    ...
                    if (constLeft.Value.GetReleaseType() == typeof(string) && _op == PythonOperator.Add) {
                    ...
                    if (constLeft.Value.GetReleaseType() == typeof(string) && constRight.Value.GetReleaseType() == typeof(int)) {
                    ...
                    } else if (constLeft.Value.GetReleaseType() == typeof(int) && constRight.Value.GetReleaseType() == typeof(string)) {
