...
using LightLambdaExpression = AnyPrefix.Microsoft.Scripting.Ast.LightLambdaExpression;
...
namespace IronPython.Compiler.Ast {
    ...
    public class ClassDefinition : ScopeStatement {
        ...
        private AnyPrefix.Microsoft.Scripting.Ast.LightExpression<Func<CodeContext, CodeContext>> MakeClassBody() {
        ...
        private class SelfNameFinder : PythonWalker {
            ...
            private MyDictionary<string, bool> _names = new MyDictionary<string, bool>(StringComparer.Ordinal);
