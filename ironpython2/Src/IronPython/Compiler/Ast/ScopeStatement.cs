...
namespace IronPython.Compiler.Ast {
    ...
    public abstract class ScopeStatement : Statement {
        ...
        private MyDictionary<string, PythonVariable> _variables;          // mapping of string to variables
        ...
        private MyDictionary<string, PythonReference> _references;        // names of all variables referenced, null after binding completes

        internal MyDictionary<PythonVariable, MSAst.Expression> _variableMapping = new MyDictionary<PythonVariable, MSAst.Expression>();
        ...
        internal MyDictionary<string, PythonVariable> Variables {
        ...
        internal abstract AnyPrefix.Microsoft.Scripting.Ast.LightLambdaExpression GetLambda();
        ...
        private void EnsureVariables() {
            if (_variables == null) {
                _variables = new MyDictionary<string, PythonVariable>(StringComparer.Ordinal);
            }
        }
        ...
        internal PythonReference Reference(string name) {
            if (_references == null) {
                _references = new MyDictionary<string, PythonReference>(StringComparer.Ordinal);
            }
