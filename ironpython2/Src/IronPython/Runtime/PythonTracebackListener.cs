...
namespace IronPython.Runtime {
    internal sealed class PythonTracebackListener : Debugging.ITraceCallback {
        ...
        public void OnTraceEvent(Debugging.TraceEventKind kind, string name, string sourceFileName, SourceSpan sourceSpan, Func<IMyDictionary<object, object>> scopeCallback, object payload, object customPayload) {        
