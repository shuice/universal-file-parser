...
namespace IronPython {
    ...
    public sealed class PythonOptions : LanguageOptions {
        ...
        public PythonOptions(IMyDictionary<string, object> options)
        ...
        private static IMyDictionary<string, object> EnsureSearchPaths(IMyDictionary<string, object> options) {
            if (options == null) {
                return new MyDictionary<string, object>() { { "SearchPaths", new[] { "." } } };
