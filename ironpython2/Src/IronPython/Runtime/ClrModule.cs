...
#if FEATURE_COM
using ComTypeLibInfo = AnyPrefix.Microsoft.Scripting.ComInterop.ComTypeLibInfo;
using ComTypeLibDesc = AnyPrefix.Microsoft.Scripting.ComInterop.ComTypeLibDesc;
#endif
...
import Namespace.")]
        ...
        /// </summary>
        public static void CompileModules(CodeContext/*!*/ context, string/*!*/ assemblyName, [ParamDictionary]IMyDictionary<string, object> kwArgs, params string/*!*/[]/*!*/ filenames) {
            ...
            MyDictionary<string, string> packageMap = BuildPackageMap(filenames);
        ...
        /// "package.b.c".
        /// </summary>
        private static MyDictionary<string/*!*/, string/*!*/>/*!*/ BuildPackageMap(string/*!*/[]/*!*/ filenames) {
            ...
            MyDictionary<string, string> packageMap = new MyDictionary<string, string>();
