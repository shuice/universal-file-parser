...
namespace IronPython.Runtime.Binding {
    ...
    class PythonBinaryOperationBinder : BinaryOperationBinder, IPythonSite, IExpressionSerializable, ILightExceptionBinder {
        ...
        private object StringModulo(CallSite site, object self, PythonDictionary other) {
            if (self != null && self.GetReleaseType() == typeof(string)) {
        ...
        private object DoubleAdd(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(double) && 
                other != null && other.GetReleaseType() == typeof(double)) {
        ...
        private object IntAdd(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(int) && 
                other != null && other.GetReleaseType() == typeof(int)) {
        ...
        private object IntAdd(CallSite site, int self, object other) {
            if (other != null && other.GetReleaseType() == typeof(int)) {
        ...
        private object ListIntMultiply(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(List) &&
                other != null && other.GetReleaseType() == typeof(int)) {
        ...
        private object TupleIntMultiply(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(PythonTuple) &&
                other != null && other.GetReleaseType() == typeof(int)) {
        ...
        private object ListAdd(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(List) &&
                other != null && other.GetReleaseType() == typeof(List)) {
        ...
        private object TupleAdd(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(PythonTuple) &&
                other != null && other.GetReleaseType() == typeof(PythonTuple)) {
        ...
        private object StringAdd(CallSite site, object self, object other) {
            if (self != null && self.GetReleaseType() == typeof(string) && 
                other != null && other.GetReleaseType() == typeof(string)) {
