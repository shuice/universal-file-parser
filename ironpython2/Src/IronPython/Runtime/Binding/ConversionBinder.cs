    ...
    class PythonConversionBinder : DynamicMetaObjectBinder, IPythonSite, IExpressionSerializable {
            ...
            switch (type.GetTypeCode()) {
                ...
                case TypeCode.Object:
                    ...
                    if (type.IsArray && self.Value is PythonTuple && type.GetArrayRank() == 1) {
                        ...
                        } else if (genTo == typeof(IMyDictionary<,>)) {
                            res = TryToGenericInterfaceConversion(self, type, typeof(IMyDictionary<object, object>), typeof(DictionaryGenericWrapper<,>));
        ...
        public override T BindDelegate<T>(CallSite<T> site, object[] args) {
            ...
            if (typeof(T) == typeof(Func<CallSite, object, string>) && target is string) {
                ...
                } else if (target.GetReleaseType() == typeof(object)) {
                    res = (T)(object)new Func<CallSite, object, bool>(ObjectToBoolConversion);
                } else if (target.GetReleaseType() == typeof(List)) {
                    res = (T)(object)new Func<CallSite, object, bool>(ListToBoolConversion);
                } else if (target.GetReleaseType() == typeof(PythonTuple)) {
                ...
                } else if (target.GetReleaseType() == typeof(Bytes)) {
                ...
                if (res == null && (target.GetReleaseType() == Type || Type.IsAssignableFrom(target.GetReleaseType()))) {
                    if (typeof(T) == typeof(Func<CallSite, object, object>)) {
                        // called via a helper call site in the runtime (e.g. Converter.Convert)
                        res = (T)(object)new Func<CallSite, object, object>(new IdentityConversion(target.GetReleaseType()).Convert);
                    } else {
                        // called via an embedded call site
                        Debug.Assert(typeof(T).GetMethod("Invoke").ReturnType == Type);
                        if (typeof(T).GetMethod("Invoke").GetParameters()[1].ParameterType == typeof(object)) {
                            object identityConversion = Activator.CreateInstance(typeof(IdentityConversion<>).MakeGenericType(Type), target.GetReleaseType());
                            res = (T)(object)identityConversion.GetReleaseType().GetMethod("Convert").CreateDelegate(typeof(T), identityConversion);
                        }
                    }
                }
            }
        ...
        public bool ObjectToBoolConversion(CallSite site, object value) {
            if (value != null && value.GetReleaseType() == typeof(Object)) {
                return true;
            } else if (value == null) {
        ...
        public bool ListToBoolConversion(CallSite site, object value) {
            if (value == null) {
                return false;
            } else if (value.GetReleaseType() == typeof(List)) {
        ...
        public bool TupleToBoolConversion(CallSite site, object value) {
            if (value == null) {
                return false;
            } else if (value.GetReleaseType() == typeof(PythonTuple)) {
        ...
        public IEnumerable ObjectToIEnumerableConversion(CallSite site, object value) {
            if (value != null) {
                ...
                } else if (value.GetReleaseType() == typeof(Bytes)) {
                    return _context.PythonOptions.Python30 ?
        ...
        class IdentityConversion {
            ...
            public object Convert(CallSite site, object value) {
                if (value != null && value.GetReleaseType() == _type) {
                    return value;
                }
