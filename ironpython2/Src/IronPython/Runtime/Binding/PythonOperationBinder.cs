...
namespace IronPython.Runtime.Binding {
    ...
    class PythonOperationBinder : DynamicMetaObjectBinder, IPythonSite, IExpressionSerializable {
            ...
            switch(_operation) {
                ...
                case PythonOperationKind.GetEnumeratorForIteration:
                    if (CompilerHelpers.GetType(args[0]) == typeof(List)) {
                        if (typeof(T) == typeof(Func<CallSite, List, MyKeyValuePair<IEnumerator, IDisposable>>)) {
                            return (T)(object)new Func<CallSite, List, MyKeyValuePair<IEnumerator, IDisposable>>(GetListEnumerator);
                        }
                        return (T)(object)new Func<CallSite, object, MyKeyValuePair<IEnumerator, IDisposable>>(GetListEnumerator);
                    } else if (CompilerHelpers.GetType(args[0]) == typeof(PythonTuple)) {
                        if (typeof(T) == typeof(Func<CallSite, PythonTuple, MyKeyValuePair<IEnumerator, IDisposable>>)) {
                            return (T)(object)new Func<CallSite, PythonTuple, MyKeyValuePair<IEnumerator, IDisposable>>(GetTupleEnumerator);
                        }
                        return (T)(object)new Func<CallSite, object, MyKeyValuePair<IEnumerator, IDisposable>>(GetTupleEnumerator);
        ...
        private MyKeyValuePair<IEnumerator, IDisposable> GetListEnumerator(CallSite site, List value) {
            return new MyKeyValuePair<IEnumerator,IDisposable>(new ListIterator(value), null);
        }

        private MyKeyValuePair<IEnumerator, IDisposable> GetListEnumerator(CallSite site, object value) {
            if (value != null && value.GetReleaseType() == typeof(List)) {
                return new MyKeyValuePair<IEnumerator,IDisposable>(new ListIterator((List)value), null);
            }

            return ((CallSite<Func<CallSite, object, MyKeyValuePair<IEnumerator, IDisposable>>>)site).Update(site, value);
        }

        private MyKeyValuePair<IEnumerator, IDisposable> GetTupleEnumerator(CallSite site, PythonTuple value) {
            return new MyKeyValuePair<IEnumerator,IDisposable>(new TupleEnumerator(value), null);
        }

        private MyKeyValuePair<IEnumerator, IDisposable> GetTupleEnumerator(CallSite site, object value) {
            if (value != null && value.GetReleaseType() == typeof(PythonTuple)) {
                return new MyKeyValuePair<IEnumerator, IDisposable>(new TupleEnumerator((PythonTuple)value), null);
            }
        ...
        private bool SetContains(CallSite site, object other, object value) {
            if (value != null && value.GetReleaseType() == typeof(SetCollection)) {
        ...
        private int HashPythonType(CallSite site, object value) {
            if (value != null && value.GetReleaseType() == typeof(PythonType)) {
        ...
        private int CompareStrings(CallSite site, object arg0, object arg1) {
            if (arg0 != null && arg0.GetReleaseType() == typeof(string) &&
                arg1 != null && arg1.GetReleaseType() == typeof(string)) {
        ...
        public override Type ReturnType {
            get {
                switch (Operation & (~PythonOperationKind.DisableCoerce)) {
                    ...
                    case PythonOperationKind.GetEnumeratorForIteration: return typeof(MyKeyValuePair<IEnumerator, IDisposable>);
