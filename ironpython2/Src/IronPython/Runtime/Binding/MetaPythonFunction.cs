    ...
    class MetaPythonFunction : MetaPythonObject, IPythonInvokable, IPythonOperable, IPythonConvertible, IInferableInvokable, IConvertibleMetaObject, IPythonGetable {
        ...
        class FunctionBinderHelper {
            ...
            private Expression/*!*/[]/*!*/ GetArgumentsForRule() {
                ...
                MyDictionary<string, Expression> namedArgs = null;
                int instanceIndex = Signature.IndexOf(ArgumentType.Instance);
                ...
                for (int i = 0; i < _args.Length; i++) {
                    ...
                    switch (Signature.GetArgumentKind(i)) {
                        ...
                        case ArgumentType.Named:
                            ...
                            if (!foundName) {
                                if (namedArgs == null) {
                                    namedArgs = new MyDictionary<string, Expression>();
                                }
            ...
            /// </summary>
            private bool FinishArguments(Expression[] exprArgs, List<Expression> paramsArgs, MyDictionary<string, Expression> namedArgs) {
            ...
            /// </summary>
            private bool TryFinishDictionary(Expression[] exprArgs, MyDictionary<string, Expression> namedArgs) {
                if (_func.Value.ExpandDictPosition != -1) {
                    if (_dict != null) {
                        ...
                        if (namedArgs != null) {
                            foreach (MyKeyValuePair<string, Expression> kvp in namedArgs) {
            ...
            private void MakeDictionaryAddition(MyKeyValuePair<string, Expression> kvp) {
                _init.Add(
                    Ast.Call(
            ...
            private Expression/*!*/[]/*!*/ GetArgumentsForTargetType(Expression[] exprArgs) {
                Type target = _func.Value.func_code.Target.GetReleaseType();
            ...
            /// </summary>
            private Expression MakeDictionary(MyDictionary<string, Expression/*!*/> namedArgs) {
                Debug.Assert(_dict == null);
                _temps.Add(_dict = Ast.Variable(typeof(PythonDictionary), "$dict"));
            ...
            private Expression/*!*/ MakeFunctionInvoke(Expression[] invokeArgs) {
                Type targetType = _func.Value.func_code.Target.GetReleaseType();
            ...
            private void MakeUnexpectedKeywordError(MyDictionary<string, Expression> namedArgs) {
                string name = null;
