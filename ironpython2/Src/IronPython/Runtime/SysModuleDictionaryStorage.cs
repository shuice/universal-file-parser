    ...
    class SysModuleDictionaryStorage : ModuleDictionaryStorage {
        ...
        public override List<MyKeyValuePair<object, object>> GetItems() {
            ...
            if (TryGetValue("exc_traceback", out value)) {
                res.Add(new MyKeyValuePair<object, object>("exc_traceback", value));
            }
            if (TryGetValue("exc_type", out value)) {
                res.Add(new MyKeyValuePair<object, object>("exc_type", value));
            }
            if (TryGetValue("exc_value", out value)) {
                res.Add(new MyKeyValuePair<object, object>("exc_value", value));
            }
