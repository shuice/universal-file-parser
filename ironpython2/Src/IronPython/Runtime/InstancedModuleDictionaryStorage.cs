...
namespace IronPython.Runtime {
    ...
    class InstancedModuleDictionaryStorage : ModuleDictionaryStorage {
        ...
        public InstancedModuleDictionaryStorage(BuiltinPythonModule/*!*/ moduleInstance, MyDictionary<string, PythonGlobal> globalsDict)
            : base(moduleInstance.GetReleaseType(), globalsDict) {
