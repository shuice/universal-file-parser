...
namespace IronPython.Runtime {
    ...
    public sealed class Profiler {
        private readonly MyDictionary<MethodBase/*!*/, int>/*!*/ _methods; // Unique lookup of methods -> profile indices
        private readonly MyDictionary<string/*!*/, int>/*!*/ _names;       // Unique lookup of names -> profile indices; not all names are unique
        ...
        private Profiler() {
            _methods = new MyDictionary<MethodBase, int>();
            _names = new MyDictionary<string, int>();
