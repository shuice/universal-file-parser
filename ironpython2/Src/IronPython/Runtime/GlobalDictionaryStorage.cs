...
namespace IronPython.Runtime {
    class GlobalDictionaryStorage : CustomDictionaryStorage {
        private readonly MyDictionary<string, PythonGlobal/*!*/>/*!*/ _globals;
        private readonly PythonGlobal[] _data;
        private PythonGlobal _path, _package, _builtins, _name;

        public GlobalDictionaryStorage(MyDictionary<string, PythonGlobal/*!*/>/*!*/ globals) {
            Assert.NotNull(globals);

            _globals = globals;
        }

        public GlobalDictionaryStorage(MyDictionary<string, PythonGlobal/*!*/>/*!*/ globals, PythonGlobal/*!*/[]/*!*/ data) {
        ...
        protected override IEnumerable<MyKeyValuePair<string, object>> GetExtraItems() {
            foreach (MyKeyValuePair<string, PythonGlobal> global in _globals) {
                if (global.Value.RawValue != Uninitialized.Instance) {
                    yield return new MyKeyValuePair<string, object>(global.Key, global.Value.RawValue);
                }
            }
        }
