...
namespace IronPython.Runtime {
    ...
    public class FunctionCode : IExpressionSerializable, ICodeFormattable {
        ...
        private LambdaExpression GetGeneratorOrNormalLambdaTracing(PythonContext context) {
            ...
            var debugInfo = new AnyPrefix.Microsoft.Scripting.Debugging.CompilerServices.DebugLambdaInfo(
        ...
        class TargetUpdaterForCompilation {
            ...
            public void SetCompiledTarget(object sender, AnyPrefix.Microsoft.Scripting.Interpreter.LightLambdaCompileEventArgs e) {
                _code.SetTarget(_code.AddRecursionCheck(_context, _code._normalDelegate = e.Compiled));
            }

            public void SetCompiledTargetTracing(object sender, AnyPrefix.Microsoft.Scripting.Interpreter.LightLambdaCompileEventArgs e) {
    ...
    internal class PythonDebuggingPayload {
        ...
        private MyDictionary<int, bool> _handlerLocations;
        private MyDictionary<int, MyDictionary<int, bool>> _loopAndFinallyLocations;

        public PythonDebuggingPayload(FunctionCode code) {
            Code = code;
        }

        public MyDictionary<int, bool> HandlerLocations {
            get {
        ...
        public MyDictionary<int, MyDictionary<int, bool>> LoopAndFinallyLocations {
            get {
        ...
        class TracingWalker : Compiler.Ast.PythonWalker {
            ...
            private int _loopId;
            public MyDictionary<int, bool> HandlerLocations = new MyDictionary<int, bool>();
            public MyDictionary<int, MyDictionary<int, bool>> LoopAndFinallyLocations = new MyDictionary<int, MyDictionary<int, bool>>();
            private MyDictionary<int, bool> _loopIds = new MyDictionary<int, bool>();
            ...
            private void UpdateLoops(Compiler.Ast.Statement stmt) {
                if (_inFinally || _inLoop) {
                    if (!LoopAndFinallyLocations.ContainsKey(stmt.Span.Start.Line)) {
                        LoopAndFinallyLocations.Add(stmt.Span.Start.Line, new MyDictionary<int, bool>(LoopOrFinallyIds));
                    }
                }
            }

            public MyDictionary<int, bool> LoopOrFinallyIds {
                get {
                    if (_loopIds == null) {
                        _loopIds = new MyDictionary<int, bool>();
                    }
                    return _loopIds;
                }
            }
