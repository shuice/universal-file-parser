...
namespace IronPython.Runtime.Operations {
    ...
    public static class InstanceOps {
        ...
        public static object DefaultNewClsKW(CodeContext context, PythonType type\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, params object[] args\u00F8) {
            object res = DefaultNew(context, type\u00F8, args\u00F8);

            if (kwargs\u00F8.Count > 0) {
                foreach (MyKeyValuePair<object, object> kvp in (IMyDictionary<object, object>)kwargs\u00F8) {
        ...
        public static object OverloadedNewKW(CodeContext context, BuiltinFunction overloads\u00F8, PythonType type\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8) {
            if (type\u00F8 == null) throw PythonOps.TypeError("__new__ expected type object, got {0}", PythonOps.Repr(context, DynamicHelpers.GetPythonType(type\u00F8)));
            
            return overloads\u00F8.Call(context, null, null, ArrayUtils.EmptyObjects, kwargs\u00F8);
        }

        public static object OverloadedNewClsKW(CodeContext context, BuiltinFunction overloads\u00F8, PythonType type\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, params object[] args\u00F8) {
            if (type\u00F8 == null) throw PythonOps.TypeError("__new__ expected type object, got {0}", PythonOps.Repr(context, DynamicHelpers.GetPythonType(type\u00F8)));
            if (args\u00F8 == null) args\u00F8 = new object[1];
        ...
        public static void DefaultInitKW(CodeContext context, object self, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, params object[] args\u00F8) {
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "context")]
        [StaticExtensionMethod]
        public static object NonDefaultNewKW(CodeContext context, PythonType type\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, params object[] args\u00F8) {
            if (type\u00F8 == null) throw PythonOps.TypeError("__new__ expected type object, got {0}", PythonOps.Repr(context, DynamicHelpers.GetPythonType(type\u00F8)));
            if (args\u00F8 == null) args\u00F8 = new object[1];
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "context")]
        [StaticExtensionMethod]
        public static object NonDefaultNewKWNoParams(CodeContext context, PythonType type\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8) {
            if (type\u00F8 == null) throw PythonOps.TypeError("__new__ expected type object, got {0}", PythonOps.Repr(context, DynamicHelpers.GetPythonType(type\u00F8)));
        ...
        internal static void CheckNewArgs(CodeContext context, IMyDictionary<object, object> dict, object[] args, PythonType pt) {
        ...
        internal static void CheckInitArgs(CodeContext context, IMyDictionary<object, object> dict, object[] args, object self) {
            if (((args != null && args.Length > 0) || (dict != null && dict.Count > 0))) {
        ...
        private static void GetKeywordArgs(IMyDictionary<object, object> dict, object[] args, out object[] finalArgs, out string[] names) {
            finalArgs = new object[args.Length + dict.Count];
            Array.Copy(args, finalArgs, args.Length);
            names = new string[dict.Count];
            int i = 0;
            foreach (MyKeyValuePair<object, object> kvp in dict) {
