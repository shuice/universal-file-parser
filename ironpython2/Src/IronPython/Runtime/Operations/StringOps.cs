...
namespace IronPython.Runtime.Operations {
    ...
    public static class StringOps {
        ...
        /// Conversion can be 'r' for repr or 's' for string.
        /// </summary>
        public static string/*!*/ format(CodeContext/*!*/ context, string format_string\u00F8, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, params object[] args\u00F8) {
            return NewStringFormatter.FormatString(
                context.LanguageContext,
                format_string\u00F8,
        ...
        static class CodecsInfo {
            public static readonly MyDictionary<string, EncodingInfoWrapper> Codecs = MakeCodecsDict();

            private static MyDictionary<string, EncodingInfoWrapper> MakeCodecsDict() {
                MyDictionary<string, EncodingInfoWrapper> d = new MyDictionary<string, EncodingInfoWrapper>();
#if NETCOREAPP || NETSTANDARD
                ...
                foreach (MyKeyValuePair<string, EncodingInfoWrapper> kvp in d) {
        ...
        private static void TryStringOrTuple(object prefix) {
            ...
            if (!(prefix is string) && !(prefix is PythonTuple) && !(prefix is Extensible<string>)) {
                throw PythonOps.TypeError("expected string or Tuple, got {0} Type", prefix.GetReleaseType());
            }
        }
