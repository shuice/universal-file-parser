...
namespace IronPython.Runtime.Operations {
    public static class EnumOps {        
        ...
        public static object BitwiseOr(object self, object other) {
            ...
            throw PythonOps.ValueError("bitwise or cannot be applied to {0} and {1}", self.GetReleaseType(), other.GetReleaseType());
        }
        ...
        public static object BitwiseAnd(object self, object other) {
            ...
            throw PythonOps.ValueError("bitwise and cannot be applied to {0} and {1}", self.GetReleaseType(), other.GetReleaseType());
        }
        ...
        public static object ExclusiveOr(object self, object other) {
            ...
            throw PythonOps.ValueError("bitwise xor cannot be applied to {0} and {1}", self.GetReleaseType(), other.GetReleaseType());
        }
        ...
        public static object OnesComplement(object self) {
            ...
            throw PythonOps.ValueError("one's complement cannot be applied to {0}", self.GetReleaseType());
        }

        public static bool __nonzero__(object self) {
            if (self is Enum) {
                Type selfType = self.GetReleaseType();
            ...
            throw PythonOps.ValueError("__nonzero__ cannot be applied to {0}", self.GetReleaseType());
        }

        public static string __repr__(object self) {
            if (Enum.IsDefined(self.GetReleaseType(), self)) {
                string name = Enum.GetName(self.GetReleaseType(), self);
                return self.GetReleaseType().FullName + "." + name;
            }

            return String.Format("<enum {0}: {1}>", self.GetReleaseType().FullName, self.ToString());
        }
    }
}
