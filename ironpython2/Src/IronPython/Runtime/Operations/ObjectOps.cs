...
namespace IronPython.Runtime.Operations {
    ...
    public static class ObjectOps {
        ...
        [MultiRuntimeAware]
        private static MyDictionary<PythonType, object> _nativelyPickleableTypes;
        ...
        /// Initializes the object.  The base class does nothing.
        /// </summary>
        public static void __init__(CodeContext/*!*/ context, object self, [ParamDictionary]IMyDictionary<object, object> kwargs, params object[] args\u00F8) {
        ...
        /// </summary>
        [StaticExtensionMethod]
        public static object __new__(CodeContext/*!*/ context, PythonType cls, [ParamDictionary]IMyDictionary<object, object> kwargs\u00F8, [NotNull]params object[] args\u00F8) {
            if (cls == null) {
                throw PythonOps.TypeError("__new__ expected type object, got {0}", PythonOps.Repr(context, DynamicHelpers.GetPythonType(cls)));
            }
        ...
        private static MyDictionary<PythonType, object> NativelyPickleableTypes {
            get {
                if (_nativelyPickleableTypes == null) {
                    MyDictionary<PythonType, object> typeDict = new MyDictionary<PythonType, object>();
