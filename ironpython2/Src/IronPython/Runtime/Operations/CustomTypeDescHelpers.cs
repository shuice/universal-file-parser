    ...
    public static class CustomTypeDescHelpers {
        ...
        static PropertyDescriptor[] GetPropertiesImpl(object self, Attribute[] attributes) {
            ...
            if (attrNames != null) {
                foreach (object o in attrNames) {
                    ...
                    Type attrType = (attrVal == null) ? typeof(NoneTypeOps) : attrVal.GetReleaseType();

                    if ((attrSlot != null && ShouldIncludeProperty(attrSlot, attributes)) ||
                        (attrSlot == null && ShouldIncludeInstanceMember(s, attributes))) {
                        descrs.Add(new SuperDynamicObjectPropertyDescriptor(s, attrType, self.GetReleaseType()));
                    }
                }
            }
        ...
        private static bool ShouldIncludeInstanceMember(string memberName, Attribute[] attributes) {
            ...
            foreach (Attribute attr in attributes) {
                if (attr.GetReleaseType() == typeof(BrowsableAttribute)) {
        ...
        private static bool ShouldIncludeProperty(PythonTypeSlot attrSlot, Attribute[] attributes) {
            ...
            foreach (Attribute attr in attributes) {
                ...
                if ((rp = attrSlot as ReflectedProperty) != null && rp.Info != null) {
                    include &= rp.Info.IsDefined(attr.GetReleaseType(), true);
                } else if (attr.GetReleaseType() == typeof(BrowsableAttribute)) {
        ...
        private class TypeConv : TypeConverter {
            ...
            public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
                return Converter.CanConvertFrom(sourceType, convObj.GetReleaseType(), NarrowingLevel.All);
            }

            public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value) {
                return Converter.Convert(value, convObj.GetReleaseType());
            }
            ...
            public override bool IsValid(ITypeDescriptorContext context, object value) {
                object result;
                return Converter.TryConvert(value, convObj.GetReleaseType(), out result);
            }
            #endregion
        }
    }
