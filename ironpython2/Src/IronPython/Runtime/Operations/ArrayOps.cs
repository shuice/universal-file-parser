...
namespace IronPython.Runtime.Operations {
    public static class ArrayOps {
        ...
        public static Array Add(Array data1, Array data2) {
            ...
            Type type1 = data1.GetReleaseType();
            Type type2 = data2.GetReleaseType();
        ...
        public static Array Multiply(Array data, int count) {
            ...
            Type elemType = data.GetReleaseType().GetElementType();
        ...
        public static void SetItem(Array data, int index, object value) {
            ...
            data.SetValue(Converter.Convert(value, data.GetReleaseType().GetElementType()), PythonOps.FixIndex(index, data.Length) + data.GetLowerBound(0));
        }
        ...
        public static void SetItem(Array a, Slice index, object value) {
            ...
            Type elm = a.GetReleaseType().GetElementType();
        ...
        public static string __repr__(CodeContext/*!*/ context, [NotNull]Array/*!*/ self) {
            ...
            try {
                ...
                if (self.Rank == 1) {
                    ...
                    ret.Append("Array[");
                    Type elemType = self.GetReleaseType().GetElementType();
        ...
        internal static Array GetSlice(Array data, int size, Slice slice) {
            ...
            if ((step > 0 && start >= stop) || (step < 0 && start <= stop)) {
                if (data.GetReleaseType().GetElementType() == typeof(object))
                    return ArrayUtils.EmptyObjects;

                return Array.CreateInstance(data.GetReleaseType().GetElementType(), 0);
            }

            if (step == 1) {
                int n = stop - start;
                Array ret = Array.CreateInstance(data.GetReleaseType().GetElementType(), n);
