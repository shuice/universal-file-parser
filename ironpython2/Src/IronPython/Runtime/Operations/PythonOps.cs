...
using AnyPrefix.Microsoft.Scripting.Hosting.Providers;
using AnyPrefix.Microsoft.Scripting.Hosting.Shell;
...
namespace IronPython.Runtime.Operations {
    ...
    public static partial class PythonOps {
        ...
        internal static object LookupEncodingError(CodeContext/*!*/ context, string name) {
            MyDictionary<string, object> errorHandlers = context.LanguageContext.ErrorHandlers;
            lock (errorHandlers) {
        ...
        public static string Repr(CodeContext/*!*/ context, object o) {
            ...
            PerfTrack.NoteEvent(PerfTrack.Categories.Temporary, "Repr " + o.GetReleaseType().FullName);
...
#if FEATURE_COM
            if (o.GetReleaseType() == typeof(object).Assembly.GetType("System.__ComObject")) return ComOps.__repr__(o);
#endif
        ...
        public static int CompareTypesWorker(CodeContext/*!*/ context, bool shouldWarn, object x, object y) {
            ...
            if (DynamicHelpers.GetPythonType(x) != DynamicHelpers.GetPythonType(y)) {
                ...
                if (x.GetReleaseType() == typeof(OldInstance)) {
                    name1 = ((OldInstance)x)._class.Name;
                    if (y.GetReleaseType() == typeof(OldInstance)) {
                        name2 = ((OldInstance)y)._class.Name;
                    } else {
                        // old instances are always less than new-style classes
                        return -1;
                    }
                } else if (y.GetReleaseType() == typeof(OldInstance)) {
                    // old instances are always less than new-style classes
                    return 1;
                } else {
        ...
        public static bool TrySetUserDescriptor(object o, object instance, object value) {
            if (o != null && o.GetReleaseType() == typeof(OldInstance)) return false;   // only new-style classes have descriptors
        ...
        public static bool TryDeleteUserDescriptor(object o, object instance) {
            if (o != null && o.GetReleaseType() == typeof(OldInstance)) return false;   // only new-style classes can have descriptors
        ...
        public static object IsMappingType(CodeContext/*!*/ context, object o) {
            if (o is IDictionary || o is PythonDictionary || o is IMyDictionary<object, object>) {
        ...
        public static object GetEnumeratorValues(CodeContext/*!*/ context, object e, int expected) {
            if (e != null && e.GetReleaseType() == typeof(PythonTuple)) {
        ...
        public static object GetEnumeratorValuesNoComplexSets(CodeContext/*!*/ context, object e, int expected) {
            if (e != null && e.GetReleaseType() == typeof(List)) {
        ...
        public static MyKeyValuePair<IEnumerator, IDisposable> ThrowTypeErrorForBadIteration(CodeContext/*!*/ context, object enumerable) {
        ...
        public static void ForLoopDispose(MyKeyValuePair<IEnumerator, IDisposable> iteratorInfo) {
            if (iteratorInfo.Value != null) {
                iteratorInfo.Value.Dispose();
            }
        }

        public static MyKeyValuePair<IEnumerator, IDisposable> StringEnumerator(string str) {
            return new MyKeyValuePair<IEnumerator, IDisposable>(StringOps.StringEnumerator(str), null);
        }

        public static MyKeyValuePair<IEnumerator, IDisposable> BytesEnumerator(IList<byte> bytes) {
            return new MyKeyValuePair<IEnumerator, IDisposable>(IListOfByteOps.BytesEnumerator(bytes), null);
        }

        public static MyKeyValuePair<IEnumerator, IDisposable> BytesIntEnumerator(IList<byte> bytes) {
            return new MyKeyValuePair<IEnumerator, IDisposable>(IListOfByteOps.BytesIntEnumerator(bytes), null);
        }

        public static MyKeyValuePair<IEnumerator, IDisposable> GetEnumeratorFromEnumerable(IEnumerable enumerable) {
            IEnumerator enumerator = enumerable.GetEnumerator();
            return new MyKeyValuePair<IEnumerator, IDisposable>(enumerator, enumerator as IDisposable);
        }
        ...
        public static PythonTuple GetOrCopyParamsTuple(PythonFunction function, object input) {
            ...
            } else if (input.GetReleaseType() == typeof(PythonTuple)) {
        ...
        public static int InitializeModuleEx(Assembly/*!*/ precompiled, string/*!*/ main, string[] references, bool ignoreEnvVars, MyDictionary<string, object> options) {
            ContractUtils.RequiresNotNull(precompiled, "precompiled");
            ContractUtils.RequiresNotNull(main, "main");

            if(options == null) {
                options = new MyDictionary<string, object>();
            }
        ...
        public static Exception Warning(string format, params object[] args) {
            ...
            return new IronPython.Runtime.Exceptions.WarningException(string.Format(format, args));
        }
