...
namespace IronPython.Runtime {
    ...
    internal abstract class DictionaryStorage  {
        ...
        public virtual void CopyTo(ref DictionaryStorage/*!*/ into) {
            ...
            foreach (MyKeyValuePair<object, object> kvp in GetItems()) {
        ...
        public virtual bool HasNonStringAttributes() {
            foreach (MyKeyValuePair<object, object> o in GetItems()) {
                if (!(o.Key is string)) {
                    return true;
                }
            }
        ...
        public abstract List<MyKeyValuePair<object, object>> GetItems();
        ...
        public virtual IEnumerator<MyKeyValuePair<object, object>> GetEnumerator() {
