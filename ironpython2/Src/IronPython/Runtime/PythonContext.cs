...
using AnyPrefix.Microsoft.Scripting.Debugging.CompilerServices;
...
using Debugging = AnyPrefix.Microsoft.Scripting.Debugging;
...
namespace IronPython.Runtime
{
    ...
    public sealed partial class PythonContext : LanguageContext {
        ...
        private readonly IMyDictionary<object, object>/*!*/ _modulesDict = new PythonDictionary();
        private readonly MyDictionary<string, ModuleGlobalCache>/*!*/ _builtinCache = new MyDictionary<string, ModuleGlobalCache>(StringComparer.Ordinal);
        private readonly MyDictionary<Type, string>/*!*/ _builtinModuleNames = new MyDictionary<Type, string>();
        private readonly PythonOptions/*!*/ _options;
        private readonly PythonModule/*!*/ _systemState;
        private readonly MyDictionary<string, Type>/*!*/ _builtinModulesDict;
        ...
        private MyDictionary<string, object> _errorHandlers;
        private List<object> _searchFunctions;
        private MyDictionary<object, object> _moduleState;
        ...
        private MyDictionary<Type, object> _genericSiteStorage;
        ...
        private MyDictionary<AttrKey, CallSite<Func<CallSite, object, object, object>>> _setAttrSites;
        private MyDictionary<AttrKey, CallSite<Action<CallSite, object>>> _deleteAttrSites;
        ...
        private CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>> _callDictSite;
        ...
        private MyDictionary<Type, CallSite<Func<CallSite, object, object>>> _implicitConvertSites;
        private MyDictionary<PythonOperationKind, CallSite<Func<CallSite, object, object, object>>> _binarySites;
        private MyDictionary<Type, DefaultPythonComparer> _defaultComparer;
        ...
        private MyDictionary<Type, CallSite<Func<CallSite, object, object, bool>>> _equalSites;

        private MyDictionary<Type, PythonSiteCache> _systemSiteCache;
        internal static object _syntaxErrorNoCaret = new object();

        // atomized binders
        private PythonInvokeBinder _invokeNoArgs, _invokeOneArg;
        private MyDictionary<CallSignature, PythonInvokeBinder/*!*/> _invokeBinders;
        private MyDictionary<string/*!*/, PythonGetMemberBinder/*!*/> _getMemberBinders;
        private MyDictionary<string/*!*/, PythonGetMemberBinder/*!*/> _tryGetMemberBinders;
        private MyDictionary<string/*!*/, PythonSetMemberBinder/*!*/> _setMemberBinders;
        private MyDictionary<string/*!*/, PythonDeleteMemberBinder/*!*/> _deleteMemberBinders;
        private MyDictionary<string/*!*/, CompatibilityGetMember/*!*/> _compatGetMember;
        private MyDictionary<string/*!*/, CompatibilityGetMember/*!*/> _compatGetMemberNoThrow;
        private MyDictionary<PythonOperationKind, PythonOperationBinder/*!*/> _operationBinders;
        private MyDictionary<ExpressionType, PythonUnaryOperationBinder/*!*/> _unaryBinders;
        private PythonBinaryOperationBinder[] _binaryBinders;
        private MyDictionary<OperationRetTypeKey<ExpressionType>, BinaryRetTypeBinder/*!*/> _binaryRetTypeBinders;
        private MyDictionary<OperationRetTypeKey<PythonOperationKind>, BinaryRetTypeBinder/*!*/> _operationRetTypeBinders;
        private MyDictionary<Type/*!*/, PythonConversionBinder/*!*/>[] _conversionBinders;
        private MyDictionary<Type/*!*/, DynamicMetaObjectBinder/*!*/>[] _convertRetObjectBinders;
        private MyDictionary<CallSignature, CreateFallback/*!*/> _createBinders;
        private MyDictionary<CallSignature, CompatibilityInvokeBinder/*!*/> _compatInvokeBinders;
        ...
        private readonly AnyPrefix.Microsoft.Scripting.Utils.ThreadLocal<PythonTracebackListener> _tracebackListeners = new AnyPrefix.Microsoft.Scripting.Utils.ThreadLocal<PythonTracebackListener>();
...
#region Generated Python Shared Call Sites Storage
        ...
        /// </summary>
        public PythonContext(ScriptDomainManager/*!*/ manager, IMyDictionary<string, object> options)
            : base(manager) {
...
#region Specialized Hashers
        ...
        private int InitialHasherImpl(object o, ref HashDelegate dlg) {
            ...
            switch (o.GetReleaseType().GetTypeCode()) {
                ...
                default:
                    if (o is IPythonObject) {
                        ...
                        dlg = new OptimizedBuiltinHasher(this, o.GetReleaseType()).Hasher;
                    }
        ...
        private int IntHasherImpl(object o, ref HashDelegate dlg) {
            if (o != null && o.GetReleaseType() == typeof(int)) {
        ...
        private int DoubleHasherImpl(object o, ref HashDelegate dlg) {
            if (o != null && o.GetReleaseType() == typeof(double)) {
        ...
        private int StringHasherImpl(object o, ref HashDelegate dlg) {
            if (o != null && o.GetReleaseType() == typeof(string)) {
                return o.GetHashCode();
            }
        ...
        private sealed class OptimizedBuiltinHasher {
            ...
            public int Hasher(object o, ref HashDelegate dlg) {
                if (o != null && o.GetReleaseType() == _type) {
                    return _pt.Hash(o);
                }
        ...
        private void EnsureModuleState() {
            if (_moduleState == null) {
                Interlocked.CompareExchange(ref _moduleState, new MyDictionary<object, object>(), null);
            }
        }
        ...
        internal IMyDictionary<object, object> SystemStateModules {
            get {
                return _modulesDict;
            }
        }
...
#region Scopes
        ...
        internal PythonModule/*!*/ CreateBuiltinModule(string moduleName, Type type) {
            ...
            if (type.IsSubclassOf(typeof(BuiltinPythonModule))) {
                ...
                var globals = new MyDictionary<string, PythonGlobal>();
...
#region Stack Traces and Exceptions
        ...
        private static string FormatCLSException(Exception e) {
            ...
            while (e != null) {
                result.Append("    ");
                result.AppendLine(e.GetReleaseType().Name);
        ...
        public override TService GetService<TService>(params object[] args) {
            if (typeof(TService) == typeof(TokenizerService)) {
                ...
                return (TService)(object)GetPythonService((AnyPrefix.Microsoft.Scripting.Hosting.ScriptEngine)args[0]);
        ...
        /// </summary>
        internal Hosting.PythonService GetPythonService(AnyPrefix.Microsoft.Scripting.Hosting.ScriptEngine engine) {
        ...
        /// </summary>
        internal MyDictionary<string, Type> BuiltinModules {
            get {
        ...
        /// </summary>
        internal MyDictionary<Type, string> BuiltinModuleNames {
            get {
        ...
        private MyDictionary<string, Type> CreateBuiltinTable() {
            MyDictionary<string, Type> builtinTable = new MyDictionary<string, Type>();
        ...
        internal void LoadBuiltins(MyDictionary<string, Type> builtinTable, Assembly assem, bool updateSys) {
        ...
        internal MyDictionary<string, object> ErrorHandlers {
            get {
                if (_errorHandlers == null) {
                    Interlocked.CompareExchange(ref _errorHandlers, new MyDictionary<string, object>(), null);
                }
        ...
        internal SiteLocalStorage<T> GetGenericSiteStorage<T>() {
            if (_genericSiteStorage == null) {
                Interlocked.CompareExchange(ref _genericSiteStorage, new MyDictionary<Type, object>(), null);
            }
        ...
        internal SiteLocalStorage<CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>> GetGenericKeywordCallSiteStorage() {
            return GetGenericSiteStorage<CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>>();
...
#region Per-Runtime Call Sites
        ...
        internal void SetAttr(CodeContext/*!*/ context, object o, string name, object value) {
            ...
            if (_setAttrSites == null) {
                Interlocked.CompareExchange(ref _setAttrSites, new MyDictionary<AttrKey, CallSite<Func<CallSite, object, object, object>>>(), null);
            }
        ...
        internal void DeleteAttr(CodeContext/*!*/ context, object o, string name) {
            ...
            if (_deleteAttrSites == null) {
                Interlocked.CompareExchange(ref _deleteAttrSites, new MyDictionary<AttrKey, CallSite<Action<CallSite, object>>>(), null);
            }
...
#region IEquatable<AttrKey> Members
        ...
        internal PythonSiteCache GetSiteCacheForSystemType(Type type) {
            if (_systemSiteCache == null) {
                Interlocked.CompareExchange(ref _systemSiteCache, new MyDictionary<Type, PythonSiteCache>(), null);
            }
...
#region Conversions
        ...
        internal object ImplicitConvertTo<T>(object value) {
            if (_implicitConvertSites == null) {
                Interlocked.CompareExchange(ref _implicitConvertSites, new MyDictionary<Type, CallSite<Func<CallSite, object, object>>>(), null);
            }
        ...
        internal object Operation(PythonOperationKind operation, object self, object other) {
            if (_binarySites == null) {
                Interlocked.CompareExchange(
                    ref _binarySites,
                    new MyDictionary<PythonOperationKind, CallSite<Func<CallSite, object, object, object>>>(),
                    null
                );
            }
        ...
        internal object CallWithKeywords(object func, object[] args, IMyDictionary<object, object> dict) {
        ...
        internal CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>> MakeKeywordSplatSite() {
            return CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>.Create(Binders.InvokeKeywords(this));
        }
        ...
        internal static int Hash(object o) {
            if (o == null)
            {
                Debug.WriteLine ($"o is null");
            }
            else
            {
                Debug.WriteLine($"o type is {o.GetReleaseType()} {o.GetReleaseType().GetTypeCode()}");
            }
...
#region Command Dispatching
            ...
            if (cmp == null) {
                if (_defaultComparer == null) {
                    Interlocked.CompareExchange(
                        ...
                        new MyDictionary<Type, DefaultPythonComparer>(),
                        null
                    );
                }
        ...
        internal CallSite<Func<CallSite, object, object, bool>> GetEqualSite(Type/*!*/ type) {
            if (_equalSites == null) {
                Interlocked.CompareExchange(ref _equalSites, new MyDictionary<Type, CallSite<Func<CallSite, object, object, bool>>>(), null);
            }
...
#region Binder Factories
        ...
        internal CompatibilityInvokeBinder/*!*/ CompatInvoke(CallInfo /*!*/ callInfo) {
            if (_compatInvokeBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<CallSignature, CompatibilityInvokeBinder>(),
                    null
                );
            }
        ...
        internal PythonConversionBinder/*!*/ Convert(Type/*!*/ type, ConversionResultKind resultKind) {
            if (_conversionBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<Type, PythonConversionBinder>[(int)ConversionResultKind.ExplicitTry + 1], // max conversion result kind
                    null
                );
            }
            ...
            if (_conversionBinders[(int)resultKind] == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<Type, PythonConversionBinder>(),
                    null
                );
            }

            MyDictionary<Type, PythonConversionBinder> dict = _conversionBinders[(int)resultKind];
            lock (dict) {
        ...
        internal DynamicMetaObjectBinder/*!*/ ConvertRetObject(Type/*!*/ type, ConversionResultKind resultKind) {
            if (_convertRetObjectBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<Type, DynamicMetaObjectBinder>[(int)ConversionResultKind.ExplicitTry + 1], // max conversion result kind
                    null
                );
            }
            ...
            if (_convertRetObjectBinders[(int)resultKind] == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<Type, DynamicMetaObjectBinder>(),
                    null
                );
            }

            MyDictionary<Type, DynamicMetaObjectBinder> dict = _convertRetObjectBinders[(int)resultKind];
            lock (dict) {
        ...
        internal CreateFallback/*!*/ Create(CompatibilityInvokeBinder/*!*/ realFallback, CallInfo /*!*/ callInfo) {
            if (_createBinders == null) {
                Interlocked.CompareExchange(
                    ref _createBinders,
                    new MyDictionary<CallSignature, CreateFallback>(),
                    null
                );
            }
        ...
        internal PythonGetMemberBinder/*!*/ GetMember(string/*!*/ name, bool isNoThrow) {
            MyDictionary<string, PythonGetMemberBinder> dict;
            if (isNoThrow) {
                if (_tryGetMemberBinders == null) {
                    Interlocked.CompareExchange(
                        ref _tryGetMemberBinders,
                        new MyDictionary<string, PythonGetMemberBinder>(),
                        null
                    );
                }
        ...
        internal CompatibilityGetMember/*!*/ CompatGetMember(string/*!*/ name, bool isNoThrow) {
            MyDictionary<string, CompatibilityGetMember> dict;
            if (isNoThrow) {
                if (_compatGetMemberNoThrow == null) {
                    Interlocked.CompareExchange(
                        ref _compatGetMemberNoThrow,
                        new MyDictionary<string, CompatibilityGetMember>(),
                        null
                    );
                }
        ...
        internal PythonSetMemberBinder/*!*/ SetMember(string/*!*/ name) {
            if (_setMemberBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<string, PythonSetMemberBinder>(),
                    null
                );
            }
        ...
        internal PythonDeleteMemberBinder/*!*/ DeleteMember(string/*!*/ name) {
            if (_deleteMemberBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<string, PythonDeleteMemberBinder>(),
                    null
                );
            }
        ...
        internal PythonInvokeBinder/*!*/ Invoke(CallSignature signature) {
            if (_invokeBinders == null) {
                Interlocked.CompareExchange(
                    ref _invokeBinders,
                    new MyDictionary<CallSignature, PythonInvokeBinder>(),
                    null
                );
            }
        ...
        internal PythonOperationBinder/*!*/ Operation(PythonOperationKind operation) {
            if (_operationBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<PythonOperationKind, PythonOperationBinder>(),
                    null
                );
            }
        ...
        internal PythonUnaryOperationBinder/*!*/ UnaryOperation(ExpressionType operation) {
            if (_unaryBinders == null) {
                Interlocked.CompareExchange(
                    ref _unaryBinders,
                    new MyDictionary<ExpressionType, PythonUnaryOperationBinder>(),
                    null
                );
            }
        ...
        internal BinaryRetTypeBinder/*!*/ BinaryOperationRetType(PythonBinaryOperationBinder opBinder, PythonConversionBinder convBinder) {
            if (_binaryRetTypeBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<OperationRetTypeKey<ExpressionType>, BinaryRetTypeBinder>(),
                    null
                );
            }
        ...
        internal BinaryRetTypeBinder/*!*/ OperationRetType(PythonOperationBinder opBinder, PythonConversionBinder convBinder) {
            if (_operationRetTypeBinders == null) {
                Interlocked.CompareExchange(
                    ...
                    new MyDictionary<OperationRetTypeKey<PythonOperationKind>, BinaryRetTypeBinder>(),
                    null
                );
            }
...
#region IEquatable<BinaryOperationRetTypeKey> Members
        ...
        public static Expression/*!*/ GetCodeContext(DynamicMetaObjectBinder/*!*/ action) {
            return AnyPrefix.Microsoft.Scripting.Ast.Utils.Constant(PythonContext.GetPythonContext(action)._defaultContext);
        }

        public static DynamicMetaObject/*!*/ GetCodeContextMO(DynamicMetaObjectBinder/*!*/ action) {
            return new DynamicMetaObject(
                AnyPrefix.Microsoft.Scripting.Ast.Utils.Constant(PythonContext.GetPythonContext(action)._defaultContext),
        ...
        public static DynamicMetaObject/*!*/ GetCodeContextMOCls(DynamicMetaObjectBinder/*!*/ action) {
            return new DynamicMetaObject(
                AnyPrefix.Microsoft.Scripting.Ast.Utils.Constant(PythonContext.GetPythonContext(action).SharedClsContext),
                BindingRestrictions.Empty,
...
#region Scope Access
        ...
        public override T ScopeGetVariable<T>(Scope scope, string name) {
            ...
            if (storage != null && storage.TryGetValue(name, false, out res)) {
                var a = res.GetReleaseType();
                var b = res.GetReleaseType().GetTypeInfo();
                // Debug.WriteLine($"{a}-{b}");
...
#region Tracing
        ...
        private class PythonTracebackListenersDispatcher : Debugging.ITraceCallback  {
            ...
            void Debugging.ITraceCallback.OnTraceEvent(Debugging.TraceEventKind kind, string name, string sourceFileName, SourceSpan sourceSpan, Func<IMyDictionary<object, object>> scopeCallback, object payload, object customPayload)
            {
