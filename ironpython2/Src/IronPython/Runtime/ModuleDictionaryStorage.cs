...
namespace IronPython.Runtime {
    ...
    class ModuleDictionaryStorage : GlobalDictionaryStorage {
        ...
        private static readonly MyDictionary<string, PythonGlobal> _emptyGlobalDict = new MyDictionary<string, PythonGlobal>(0);
        ...
        public ModuleDictionaryStorage(Type/*!*/ moduleType, MyDictionary<string, PythonGlobal> globals)
        ...
        public override List<MyKeyValuePair<object, object>> GetItems() {
            ...
            foreach (MyKeyValuePair<object, object> kvp in base.GetItems()) {
            ...
            foreach (MemberInfo mi in members) {
                ...
                if (TryGetLazyValue(mi.Name, out value)) {
                    res.Add(new MyKeyValuePair<object, object>(mi.Name, value));
                }
            }
            return res;
        }
