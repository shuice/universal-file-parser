...
namespace IronPython.Runtime.Types {
    public class CachedNewTypeInfo {
        ...
        private readonly MyDictionary<string, string[]> _specialNames;
        private readonly Type[] _interfaceTypes;

        public CachedNewTypeInfo(Type type, MyDictionary<string, string[]> specialNames, Type[] interfaceTypes) {
            _type = type;
        ...
        public MyDictionary<string, string[]> SpecialNames {
