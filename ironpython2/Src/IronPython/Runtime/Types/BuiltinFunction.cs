...
namespace IronPython.Runtime.Types {
    ...
    public partial class BuiltinFunction : PythonTypeSlot, ICodeFormattable, IDynamicMetaObjectProvider, IDelegateConvertible, IFastInvokable  {
        ...
        internal object Call(CodeContext context, SiteLocalStorage<CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>> storage, object instance, object[] args, IMyDictionary<object, object> keywordArgs) {
            if (storage == null) {
        ...
        /// </summary>
        internal MyDictionary<BuiltinFunction.TypeList, BuiltinFunction> OverloadDictionary {
            get {
                if (_data.OverloadDictionary == null) {
                    Interlocked.CompareExchange(
                        ref _data.OverloadDictionary,
                        new MyDictionary<BuiltinFunction.TypeList, BuiltinFunction>(),
                        null);
                }
        ...
        public object __call__(CodeContext/*!*/ context, SiteLocalStorage<CallSite<Func<CallSite, CodeContext, object, object[], IMyDictionary<object, object>, object>>> storage, [ParamDictionary]IMyDictionary<object, object> dictArgs, params object[] args) {
        ...
        private void EnsureBoundGenericDict() {
            if (_data.BoundGenerics == null) {
                Interlocked.CompareExchange<MyDictionary<TypeList, BuiltinFunction>>(
                    ref _data.BoundGenerics,
                    new MyDictionary<TypeList, BuiltinFunction>(1),
                    null);
            }
        }
        ...
        internal sealed class BuiltinFunctionData {
            ...
            public MyDictionary<TypeList, BuiltinFunction> BoundGenerics;
            public MyDictionary<BuiltinFunction.TypeList, BuiltinFunction> OverloadDictionary;
