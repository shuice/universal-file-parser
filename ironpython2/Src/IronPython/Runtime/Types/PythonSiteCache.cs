...
namespace IronPython.Runtime.Types {
    ...
    internal class PythonSiteCache {
        private MyDictionary<string, CallSite<Func<CallSite, object, CodeContext, object>>> _tryGetMemSite;
        private MyDictionary<string, CallSite<Func<CallSite, object, CodeContext, object>>> _tryGetMemSiteShowCls;
            ...
            if (PythonOps.IsClsVisible(context)) {
                if (_tryGetMemSiteShowCls == null) {
                    Interlocked.CompareExchange(
                        ...
                        new MyDictionary<string, CallSite<Func<CallSite, object, CodeContext, object>>>(StringComparer.Ordinal),
                        null
                    );
                }
