    ...
    public partial class PythonType {
        ...
        abstract class FastBindingBuilderBase {
            ...
            public virtual Delegate MakeBindingResult() {
                ...
                } else if (newInst.GetReleaseType() == typeof(staticmethod) && ((staticmethod)newInst)._func is PythonFunction) {
            ...
            private Delegate GetOrCreateFastNew() {
                Delegate newDlg;
                lock (_fastBindCtors) {
                    MyDictionary<Type, Delegate> fastBindCtors;
                    if (!_fastBindCtors.TryGetValue(_type.UnderlyingSystemType, out fastBindCtors)) {
                        fastBindCtors = _fastBindCtors[_type.UnderlyingSystemType] = new MyDictionary<Type, Delegate>();
