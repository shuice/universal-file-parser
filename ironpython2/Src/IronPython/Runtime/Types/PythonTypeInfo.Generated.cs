...
namespace IronPython.Runtime.Types {
    internal static partial class PythonTypeInfo {
        public static MyDictionary<string, PythonOperationKind> InitializeOperatorTable() {
            MyDictionary<string, PythonOperationKind> pyOp = new MyDictionary<string, PythonOperationKind>();
