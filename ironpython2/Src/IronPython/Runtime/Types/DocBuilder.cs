...
namespace IronPython.Runtime.Types {
    static class DocBuilder {
        ...
        public static OverloadDoc GetOverloadDoc(MethodBase info, string name, int endParamSkip, bool includeSelf) {
            ...
            List<MyKeyValuePair<string, string>> parameters = null;
        ...
        /// </summary>
        private static void GetXmlDoc(MethodBase info, out string summary, out string returns, out List<MyKeyValuePair<string, string>> parameters) {
            summary = null;
            returns = null;
            parameters = null;
            ...
            while (iter.MoveNext()) {
                switch (iter.Current.Name) {
                    ...
                    case "param":
                        ...
                        if (name != null) {
                            if (parameters == null) {
                                parameters = new List<MyKeyValuePair<string, string>>();
                            }

                            parameters.Add(new MyKeyValuePair<string, string>(name, paramText.Trim()));
                        }
                        break;
                    case "exception":
                        break;
