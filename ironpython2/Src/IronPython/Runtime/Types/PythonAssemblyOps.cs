...
namespace IronPython.Runtime.Operations {
    public static class PythonAssemblyOps {
        ...
        private static MyDictionary<Assembly, TopNamespaceTracker> GetAssemblyMap(PythonContext/*!*/ context) {
            return context.GetOrCreateModuleState(_key, () => new MyDictionary<Assembly, TopNamespaceTracker>());
        }
        ...
        public static List GetMemberNames(CodeContext/*!*/ context, Assembly self) {
            ...
            List ret = DynamicHelpers.GetPythonTypeFromType(self.GetReleaseType()).GetMemberNames(context);
