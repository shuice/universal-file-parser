...
#pragma warning disable 169 // unused method - called via reflection from serialization
        ...
        private void GetObjectData(SerializationInfo info, StreamingContext context) {
            ...
            foreach (MyKeyValuePair<object, object> kvp in _dict._storage.GetItems()) {
                keys.Add(kvp.Key);
...
#pragma warning restore 169
        ...
        [SpecialName]
        public object Call(CodeContext context, [ParamDictionary]IMyDictionary<object, object> dict\u00F8, [NotNull]params object[] args\u00F8) {
            OldInstance inst = new OldInstance(context, this);
            object meth;
        ...
        internal static void RecurseAttrHierarchy(OldClass oc, IMyDictionary<object, object> attrs) {
            foreach (MyKeyValuePair<object, object> kvp in oc._dict._storage.GetItems()) {
