...
namespace IronPython.Runtime {
    ...
    public static class DictionaryOps {
        ...
        public static string/*!*/ __repr__(CodeContext/*!*/ context, IMyDictionary<object, object> self) {
        ...
        public static bool has_key(IMyDictionary<object, object> self, object key) {
            return self.ContainsKey(key);
        }

        public static List items(IMyDictionary<object, object> self) {
        ...
        public static IEnumerator iteritems(IMyDictionary<object, object> self) {
            return ((IEnumerable)items(self)).GetEnumerator();
        }

        public static IEnumerator iterkeys(IMyDictionary<object, object> self) {
            return ((IEnumerable)keys(self)).GetEnumerator();
        }

        public static List keys(IMyDictionary<object, object> self) {
        ...
        public static PythonTuple popitem(IMyDictionary<object, object> self) {
            IEnumerator<MyKeyValuePair<object, object>> ie = self.GetEnumerator();
            if (ie.MoveNext()) {
        ...
        internal static int CompareTo(CodeContext/*!*/ context, IMyDictionary<object, object> left, IMyDictionary<object, object> right) {
            int lcnt = left.Count;
        ...
        internal static int CompareToWorker(CodeContext/*!*/ context, IMyDictionary<object, object> left, List ritems) {
