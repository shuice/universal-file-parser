...
namespace IronPython.Runtime {
    ...
    sealed class ExtensionMethodSet : IEquatable<ExtensionMethodSet> {
        ...
        private MyDictionary<Assembly, AssemblyLoadInfo>/*!*/ _loadedAssemblies;
        private int _id;
        ...
        private ExtensionMethodSet(MyDictionary<Assembly, AssemblyLoadInfo> dict) {
        ...
        private ExtensionMethodSet() {
            _loadedAssemblies = new MyDictionary<Assembly, AssemblyLoadInfo>();
        }
        ...
        private void LoadAllTypes() {
            var newAssemblies = new MyDictionary<Assembly, AssemblyLoadInfo>(_loadedAssemblies.Count);
        ...
        public static ExtensionMethodSet AddNamespace(PythonContext context, ExtensionMethodSet/*!*/ existingSet, NamespaceTracker/*!*/ ns) {
            ...
            lock (existingSet) {
                ...
                MyDictionary<Assembly, AssemblyLoadInfo> newDict = null;
        ...
        private static MyDictionary<Assembly, AssemblyLoadInfo> NewInfoOrCopy(ExtensionMethodSet/*!*/ existingSet) {
            var dict = new MyDictionary<Assembly, AssemblyLoadInfo>();
            if (existingSet != null) {
