...
namespace IronPython.Runtime {
    ...
    public class PythonDictionary : IMyDictionary<object, object>, IDictionary, 
        ...
        internal static PythonDictionary FromIAC(CodeContext context, PythonDictionary iac) {
            return iac.GetReleaseType() == typeof(PythonDictionary) ? (PythonDictionary)iac : MakeDictFromIAC(context, iac);
        }
        ...
        public void __init__(CodeContext/*!*/ context, object o\u00F8, [ParamDictionary]IMyDictionary<object, object> kwArgs) {
            update(context, o\u00F8);
            update(context, kwArgs);
        }

        public void __init__(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> kwArgs) {
            update(context, kwArgs);
        }
        ...
        [PythonHidden]
        public void Add(MyKeyValuePair<object, object> item) {
        ...
        [PythonHidden]
        public bool Contains(MyKeyValuePair<object, object> item) {
            object result;
        ...
        [PythonHidden]
        public void CopyTo(MyKeyValuePair<object, object>[] array, int arrayIndex) {
        ...
        [PythonHidden]
        public bool Remove(MyKeyValuePair<object, object> item) {
        ...
        public IEnumerator<MyKeyValuePair<object, object>> GetEnumerator() {
            foreach (MyKeyValuePair<object, object> kvp in _storage.GetItems()) {
                yield return kvp;
            }
        }
        ...
        public void update(CodeContext/*!*/ context, [ParamDictionary]IMyDictionary<object, object> other\u00F8) {
        ...
        public void update(CodeContext/*!*/ context, object other\u00F8, [ParamDictionary]IMyDictionary<object, object> otherArgs\u00F8) {
            DictionaryOps.update(context, this, other\u00F8);
        ...
        public static object fromkeys(CodeContext context, PythonType cls, object seq, object value) {
            if (seq is XRange xr) {
                ...
                if (ret.GetReleaseType() == typeof(PythonDictionary)) {
        ...
        public object __eq__(CodeContext/*!*/ context, object other) {
            if (!(other is PythonDictionary || other is IMyDictionary<object, object>))
        ...
        public object __cmp__(CodeContext context, object other) {
            ...
            if (!(other is IMyDictionary<object, object> oth)) {
        ...
        private bool EqualsWorker(object other, IEqualityComparer comparer) {
            ...
            if (!(other is IMyDictionary<object, object> oth)) return false;
        ...
        internal class DictEnumerator : IDictionaryEnumerator {
            private IEnumerator<MyKeyValuePair<object, object>> _enumerator;
            private bool _moved;

            public DictEnumerator(IEnumerator<MyKeyValuePair<object, object>> enumerator) {
        ...
        void IDictionary.Remove(object key) {
            ((IMyDictionary<object, object>)this).Remove(key);
        }
    ...
    public sealed class DictionaryValueEnumerator : IEnumerator, IEnumerator<object> {
        ...
        internal DictionaryValueEnumerator(DictionaryStorage dict) {
            ...
            int i = 0;
            foreach (MyKeyValuePair<object, object> kvp in dict.GetItems()) {
                _values[i++] = kvp.Value;
            }
            _pos = -1;
        }
