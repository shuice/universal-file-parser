...
namespace IronPython.Runtime {    
    ...
    class PythonScopeExtension : ScopeExtension {
        ...
        private MyDictionary<object, object> _objectKeys;
        ...
        public MyDictionary<object, object> EnsureObjectKeys() {
            if (_objectKeys == null) {
                Interlocked.CompareExchange(ref _objectKeys, new MyDictionary<object, object>(), null);
            }

            return _objectKeys;
        }

        public MyDictionary<object, object> ObjectKeys {
            get {
                return _objectKeys;
            }
        }
