...
namespace IronPython.Runtime.Exceptions {
    ...
    public class TraceBackFrame {
        ...
        private readonly Func<IMyDictionary<object, object>> _scopeCallback;
        ...
        internal TraceBackFrame(PythonTracebackListener traceAdapter, FunctionCode code, TraceBackFrame back, PythonDebuggingPayload debugProperties, Func<IMyDictionary<object, object>> scopeCallback) {
        ...
        private void SetLineNumber(int newLineNum) {
            ...
            MyDictionary<int, MyDictionary<int, bool>> loopAndFinallyLocations = _debugProperties.LoopAndFinallyLocations;
            MyDictionary<int, bool> handlerLocations = _debugProperties.HandlerLocations;

            MyDictionary<int, bool> currentLoopIds = null;
            ...
            while (newLineNum <= funcCode.Span.End.Line) {
                ...
                MyDictionary<int, bool> jumpIntoLoopIds;
        ...
        private static Exception BadForOrFinallyJump(int newLineNum, MyDictionary<int, bool> jumpIntoLoopIds) {
